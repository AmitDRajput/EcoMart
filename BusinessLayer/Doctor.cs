   ...
   public  class Doctor : BaseObject 
    {
        ...
        private string _DocMobileNumberForSMS;
        ...
        public string DocMobileNumberForSMS
        {
            get { return _DocMobileNumberForSMS; }
            set { _DocMobileNumberForSMS = value; }
        }
        ...
        public override void DoValidate()
        {
            try
            {
                ...
                if (DocTelephone == "")
                    ValidationMessages.Add("Please enter the Doctor Telephone No.");
       ...
       public override bool CanBeDeleted()
        ...
        public bool ReadDetailsByID()
        {
            ...
            try
            {
                ...
                if (drow != null)
                {
                    ...
                    DocAddress = Convert.ToString(drow["DocAddress1"]);                    
                    DocTelephone = Convert.ToString(drow["DocTelephone"]);
                    DocMobileNumberForSMS = Convert.ToString(drow["MobileNumberForSMS"]);
        ...
        {
            DBDoctor dbDoc = new DBDoctor();
            return dbDoc.AddDetails(Id, Name , DocAddress,DocTelephone, DocMobileNumberForSMS, DocEmailID,DocShortNameAddress,DocRegistrationNumber,DocDegree, CreatedBy, CreatedDate,CreatedTime );
        }

        public bool UpdateDetails()
        {
            DBDoctor dbDoc = new DBDoctor();
            return dbDoc.UpdateDetails(Id, Name, DocAddress, DocTelephone, DocMobileNumberForSMS, DocEmailID, DocShortNameAddress,DocRegistrationNumber,DocDegree, ModifiedBy,ModifiedDate,ModifiedTime);
        }
        ...
        {
            DBDoctor dbData = new DBDoctor();
            return dbData.GetDoctorAddress();
        }
        #endregion
    }
}
