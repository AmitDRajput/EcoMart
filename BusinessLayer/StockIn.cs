...
namespace EcoMart.BusinessLayer
{
    class StockIn : BaseObject
    {
        ...
        public override void Initialise()
        {
            ...
            _CrdbAddress = "";
            _CrdbNarration = "";
            _CrdbVouType = FixAccounts.VoucherTypeForStockIN;
            _CrdbVouNo = 0;
        ...
        public int GetAndUpdateStockInNumber(string voucherseries)
        {
            int vouno = 0;
            DBGetVouNumbers dbno = new DBGetVouNumbers();
            vouno = dbno.GetStockIn(voucherseries);
            return vouno;
        }
        ...
        {
            DBStockIn dbcrdb = new DBStockIn();
        ...
        {
            DBStockIn dbcrdbp = new DBStockIn();
            return dbcrdbp.AddDetailsProducts(Id, StockID,ProductID, Batchno, Quantity, SchemeQuanity, PurchaseRate, MRP, SaleRate,TradeRate,
                Expiry, ExpiryDate, ReasonCode, VATPer, Amount, CrdbVouType, CrdbVouNo, CrdbVouDate, DetailId, SerialNumber);
        }
