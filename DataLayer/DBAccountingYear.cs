...
namespace EcoMart.DataLayer
{
    public class DBAccountingYear
    {
        ...
        public bool GetYearEndStatus()
        {
            ...
            strSql = "Select Count(*) As Count From tblaccountingyear";
            DataRow dr = DBInterface.SelectFirstRow(strSql);

            int Cnt = 0;
            if (dr != null && string.IsNullOrEmpty(Convert.ToString(dr["Count"])) == false)
                Cnt = Convert.ToInt32(dr["Count"].ToString());
