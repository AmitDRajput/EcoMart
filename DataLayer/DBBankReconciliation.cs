...
namespace EcoMart.DataLayer
{
    class DBBankReconciliation
    {
        ...
        public DataTable GetOverviewDataNew(string fromDate, string toDate, string bankID)
        {
            DataTable dtable = new DataTable();
            string strSql = "Select distinct  tblTrnacID,VoucherID,a.VoucherType,a.VoucherNumber,a.TransactionDate," +
                            "a.AccountID,a.ChequeNumber, a.ChequeDate,a.ClearedDate,a.debit,a.credit,  b.AccName, b.AccAddress1, b.AccAddress2 from tbltrnac a inner join masteraccount b " +
        ...
        public DataTable GetOverviewDataAll(string fromDate, string toDate, string bankID)
        {
            ...
            string strSql = "Select distinct  tblTrnacID,VoucherID,a.VoucherType,a.VoucherNumber,a.TransactionDate," +
                            "a.AccountID,a.ChequeNumber, a.ChequeDate,a.ClearedDate,a.debit,a.credit, b.AccName, b.AccAddress1, b.AccAddress2 from tbltrnac a inner join masteraccount b " +
                            "on a.AccAccountId = b.AccountId  where a.AccountID = '" + bankID + "' && ((TransactionDate >= '" + fromDate + "' && TransactionDate <= '" + toDate + "') ||  (ClearedDate >= '" + fromDate + "' && ClearedDate <= '" + toDate + "'))    order by a.TransactionDate ";
        ...
        {
            bool bRetValue = false;
            string strSql = GetUpdateQueryForExpenses(voucherID, clearedDate);
        ...
        private string GetUpdateQueryForExpenses(string voucherID, string clearedDate)
        {
            Query objQuery = new Query();
