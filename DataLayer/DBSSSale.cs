...
namespace EcoMart.DataLayer
{
    public class DBSSSale
    {
        ...
        public bool AddDetailsProductsSS(int Id, int ProductID, string Batchno, int quantity,
               ...
               double gstSAmount, double gstCAmount, string newbatchno, double newmrp, double newsalerate , int debtorid)
        {
            bool bRetValue = false;
            string strSql = GetInsertQueryProductsSS(Id, ProductID, Batchno, quantity, PurchaseRate, MRP,
                      ...
                      gstCPurchaseAmount, gstSAmount, gstCAmount, newbatchno, newmrp, newsalerate,debtorid);
            if (DBInterface.ExecuteQuery(strSql) > 0)
            {
                bRetValue = true;
            }
        ...
        {
            DataTable dt = null;
            //string strSql = "Select * from tblstock where  ClosingStock EcoMartID = " + mecomartid;
            //dt = DBInterface.SelectDataTable(strSql);
            return dt;
        }
    }
