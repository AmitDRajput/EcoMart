...
namespace EcoMart.BusinessLayer
{
    public class DBGetVouNumbers
    {
        ...
        public int GetCashReceipt(string voucherseries)
        {
            ...
            bool retValue = UpdateCashReceipt(cnno + 1, voucherseries);
            if (retValue == true)
                return cnno + 1;
            else
                cnno = 0;
        ...
        private bool UpdateCashReceipt(int cn, string voucherseries)
        {
            bool retValue = true;
        ...
        public int GetCashPayment(string voucherseries)
        {
            ...
            bool retValue = UpdateCashPayment(cnno + 1, voucherseries);
            if (retValue == true)
                return cnno + 1;
            else
                cnno = 0;
        ...
        private bool UpdateCashPayment(int cn, string voucherseries)
        {
            bool retValue = true;
        ...
        public int GetBankReceipt(string voucherseries)
        {
            ...
            bool retValue = UpdateBankReceipt(cnno + 1, voucherseries);
            if (retValue == true)
                return cnno + 1;
            else
                cnno = 0;
        ...
        private bool UpdateBankReceipt(int cn, string voucherseries)
        {
            bool retValue = true;
        ...
        public int GetChequeReturn(string voucherseries)
        {
            ...
            bool retValue = UpdateChequeReturn(cnno + 1, voucherseries);
            if (retValue == true)
                return cnno + 1;
            else
                cnno = 0;
        ...
        private bool UpdateChequeReturn(int cn, string voucherseries)
        {
            bool retValue = true;
        ...
        public int GetBankPayment(string voucherseries)
        {
            ...
            bool retValue = UpdateBankPayment(cnno + 1, voucherseries);
            if (retValue == true)
                return cnno + 1;
            else
                cnno = 0;
        ...
        private bool UpdateBankPayment(int cn, string voucherseries)
        {
            bool retValue = true;
        ...
        public int GetSale(string vtype, string voucherseries)
        {
            ...
            //    }
            //}
            //else if (vtype == FixAccounts.VoucherTypeForDistributorSaleCreditStatement)
            //{
            ...
            //    }
            //}
            bool retValue = UpdateSale(dnno + 1, vtype, voucherseries);
            if (retValue)
                return dnno + 1;
            else
                return 0;
        }
        private bool UpdateSale(int dn, string vt, string voucherseries)
        {
            bool retValue = true;
            string strSql = "";
        ...
        public int GetPurchase(string vtype, string voucherseries)
        {
            ...
            bool retValue = UpdatePurchase(dnno + 1, vtype, voucherseries);
            if (retValue)
                return dnno + 1;
            else
                return 0;
        ...
        public int GetChallanPurchase(string vtype, string voucherseries)
        {
            DataRow drow = null;
            int dnno = 0;

            string strSql = "Select PurchaseChallan from tblvouchernumbers where ID = '" + voucherseries + "'";
            drow = DBInterface.SelectFirstRow(strSql);
            if (drow != null)
            {
                if (drow["PurchaseChallan"] != DBNull.Value)
                    dnno = Convert.ToInt32(drow["PurchaseChallan"]);
            }
            bool retValue = UpdateChallanPurchase(dnno + 1, vtype, voucherseries);
            if (retValue)
                return dnno + 1;
            else
                return 0;
        }
        private bool UpdateChallanPurchase(int dn, string vt, string voucherseries)
        {
            bool retValue = true;
            string strSql = "";
            strSql = "Update  tblvouchernumbers set PurchaseChallan = " + dn + " where ID = '" + voucherseries + "'";
            if (DBInterface.ExecuteQuery(strSql) <= 0)
                retValue = false;
            return retValue;
        }
        ...
        public int GetPurchaseOrder(string voucherseries)
        {
            ...
            bool retValue = UpdatePurchaseOrder(pono + 1, voucherseries);
            if (retValue)
                return pono + 1;
            else
                return 0;
        ...
        private bool UpdatePurchaseOrder(int cn, string voucherseries)
        {
            bool retValue = true;
        ...
        public int GetJVID() // did by snehal
        {

            string strSql = "SELECT MAX(ID) from voucherjv";
