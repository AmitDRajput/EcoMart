...
namespace EcoMart.DataLayer
{
    public class DBSettings
    {
        ...
        public bool AddDetails(string MsetPurchaseCopyPurchseOrder, string MsetPurchaseRounding, string MsetPurchaseHold, string MsetPurchaseIfPTR, string MsetPurchaseReadPurchaseOrder, string MsetSaleRoundOff,
                    ...
                    string MsetSaleGetOrderNumberDate, string MsetSaleGetDoctor, string MsetSaleGetDelivaryBoy)
        {
            bool bRetValue = false;
            string strSql = GetInsertQuery(MsetPurchaseCopyPurchseOrder, MsetPurchaseRounding, MsetPurchaseHold, MsetPurchaseIfPTR, MsetPurchaseReadPurchaseOrder, MsetSaleCreditSale,
                    MsetPurchaseChangeSaleRate, MsetPurchaseAllowExpriedItems, MsetSaleRoundOff, MsetSaleAskDiscountinCounterSale, MsetAskRoundingInSale,
        ...
        public bool UpdateDetails(string MsetPurchaseCopyPurchaseOrder, string MsetPurchaseRounding, string MsetPurchaseHold, string MsetPurchaseIfPTR, string MsetPurchaseReadPurchaseOrder, string MsetPurchaseChangeSaleRate, string MsetPurchaseAllowExpriedItems, string MsetSaleRoundOff,
        ...
        {
            bool bRetValue = false;
            string strSql = GetUpdateQuery(MsetPurchaseCopyPurchaseOrder, MsetPurchaseRounding, MsetPurchaseHold, MsetPurchaseIfPTR, MsetPurchaseReadPurchaseOrder, MsetPurchaseChangeSaleRate, MsetPurchaseAllowExpriedItems, MsetSaleRoundOff,
        ...
        private string GetInsertQuery(string MsetPurchaseCopyPurchseOrder, string MsetPurchaseRounding, string MsetPurchaseHold, string MsetPurchaseIfPTR, string MsetPurchaseReadPurchaseOrder, string MsetSaleRoundOff,
                    string MsetPurchaseChangeSaleRate, string MsetPurchaseAllowExpriedItems, string MsetSaleCreditSale, string MsetSaleAskDiscountinCounterSale, string MsetAskRoundingInSale,
                    string MsetSaleShowProfitInSaleBill, string MsetSaleIPDOPD, string MsetSaleDiscountWithoutVAT, string MsetGeneralProfitPercentageByPurchaseRate, string MsetGeneralExpiryLast, string MsetGeneralBatchNumberRequired, string MsetGeneralExpiryDateRequired, string MsetAskOperatorVoucherSale,
                    string MsetAskOperatorOtherThanVoucherSale, string MsetAskOperatorPurchase, string MsetAskOperatorCRDB, string MsetAskOperatorOpeningStock, string MsetAskOperatorCorrectioninRate, string MsetAskOperatorJV,
                    string MsetAskOperatorCashBankReceipt, string MsetAskOperatorCashBankPayment, string MsetScanBarCode, string MsetPurchaseIncludeCreditPurchase, string MsetPurchaseUpdateVATInMaster, string MsetSaleIncludeCreditSale, string MsetSaleSaveCustomerInMaster, string MsetSaleShowOnlyMRPInCounterSale,
...

        {
            ...
            objQuery.AddToQuery("setSaleGetOrderNumberDate", MsetSaleGetOrderNumberDate);
            objQuery.AddToQuery("setSaleGetDoctor", MsetSaleGetDoctor);
            objQuery.AddToQuery("setSaleGetDelivaryBoy", MsetSaleGetDelivaryBoy);
        ...
        private string GetUpdateQuery(string MsetPurchaseCopyPurchseOrder, string MsetPurchaseRounding, string MsetPurchaseHold, string MsetPurchaseIfPTR, string MsetPurchaseReadPurchaseOrder, string MsetPurchaseChangeSaleRate, string MsetPurchaseAllowExpriedItems, string MsetSaleRoundOff,
            string MsetSaleCreditSale, string MsetSaleAskDiscountinCounterSale, string MsetAskRoundingInSale, string MsetSaleShowProfitInSaleBill, string MsetSaleIPDOPD,
            string MsetSaleDiscountWithoutVAT, string MsetGeneralProfitPercentageByPurchaseRate, string MsetGeneralExpiryLast, string MsetGeneralBatchNumberRequired, string MsetGeneralExpiryDateRequired,
            string MsetAskOperatorVoucherSale, string MsetAskOperatorOtherThanVoucherSale, string MsetAskOperatorPurchase, string MsetAskOperatorCRDB, string MsetAskOperatorOpeningStock,
            string MsetAskOperatorCorrectioninRate, string MsetAskOperatorJV, string MsetAskOperatorCashBankReceipt, string MsetAskOperatorCashBankPayment, string MsetScanBarCode,
