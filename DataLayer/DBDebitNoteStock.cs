    ...
    public class DBDebitNoteStock
    {
        ...
        public DataTable GetOverviewData(string DbntType)
        {
            ...
            string strSql = "Select distinct  a.CRDBID,a.VoucherType,a.VoucherNumber,a.VoucherDate,a.AmountNet,a.Narration, " +
                            ...
                            "where a.AccountId = b.AccountId and a.VoucherType = " + "'" + DbntType + "' && a.VoucherDate >= '"+ General.ShopDetail.Shopsy +"' && a.VoucherDate <= '" + General.ShopDetail.Shopey + "'  order by a.voucherdate ,a.vouchernumber desc ";
        ...
        public DataTable GetOverviewDataForAllYears(string DbntType)
        {
            ...
            string strSql = "Select distinct  a.CRDBID,a.VoucherType,a.VoucherNumber,a.VoucherDate,a.AmountNet,a.Narration, " +
                            "a.AccountID, b.AccountID, b.AccName, b.AccAddress1,b.AccAddress2 from vouchercreditdebitnote a, masteraccount b " +
                            "where a.AccountId = b.AccountId and a.VoucherType = " + "'" + DbntType + "' && a.VoucherDate <= '" + General.ShopDetail.Shopey + "'  order by a.voucherdate desc,a.vouchernumber desc";
            dtable = DBInterface.SelectDataTable(strSql);
            return dtable;
        }
        ...
        public DataTable GetOverviewDataDebitNotesPending(string fromDate, string toDate)
        {
            ...
            string strSql = "Select distinct  a.CRDBID,a.VoucherType,a.VoucherNumber,a.VoucherDate,a.AmountNet,a.Narration, " +
                            "a.AccountID,a.ClearedInVoucherType,a.ClearedInVoucherNumber,a.ClearedInVoucherDate,a.ClearedInPurchaseBillNumber, b.AccountID, b.AccName, b.AccAddress1,b.AccAddress2 from vouchercreditdebitnote a left outer join masteraccount b " +
                            " on a.AccountID = b.AccountID where  (a.VoucherType = '" + FixAccounts.VoucherTypeForDebitNoteStock + "' || a.VoucherType = '" + FixAccounts.VoucherTypeForDebitNoteAmount + "') && a.VoucherDate >= '" + fromDate + "' && a.VoucherDate <= '" + toDate + "' && (a.AmountClear = 0)order by a.vouchernumber ";
            dtable = DBInterface.SelectDataTable(strSql);
            return dtable;
        }
        ...
        public DataTable GetOverviewDataDebitNotesOnlyPending(string fromDate, string toDate)
        {
            ...
            string strSql = "Select distinct  a.CRDBID,a.VoucherType,a.VoucherNumber,a.VoucherDate,a.AmountNet,a.Narration, " +
                            "a.AccountID,a.ClearedInVoucherType,a.ClearedInVoucherNumber,a.ClearedInVoucherDate,a.ClearedInPurchaseBillNumber, b.AccountID, b.AccName, b.AccAddress1,b.AccAddress2 from vouchercreditdebitnote a left outer join masteraccount b " +
                            " on a.AccountID = b.AccountID where  (a.VoucherType = '" + FixAccounts.VoucherTypeForDebitNoteStock + "' || a.VoucherType = '" + FixAccounts.VoucherTypeForDebitNoteAmount + "') && ClearedInID is null && a.VoucherDate >= '" + fromDate + "' && a.VoucherDate <= '" + toDate + "'  order by a.vouchernumber ";
            dtable = DBInterface.SelectDataTable(strSql);
            return dtable;
        }
