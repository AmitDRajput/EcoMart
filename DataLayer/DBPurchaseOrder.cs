    ...
    public class DBPurchaseOrder
    {
        ...
        public  DataTable GetOverviewData()
        {
            ...
            string strSql = "Select distinct  a.ID,a.VoucherType,a.VoucherNumber,a.VoucherDate,a.Amount, " +
                            "a.AccountID,a.Narration, b.AccountID, b.AccName, b.AccAddress1,b.AccAddress2 from masterpurchaseorderstockist a, masteraccount b " +
        ...
        public DataRow ReadDetailsByID(string Id)
        {
            ...
            if (Id != "")
            {
                string strSql = "Select * from masterpurchaseorderstockist where ID ='{0}' ";
        ...
        public DataRow ReadDetailsByVoucherNumber(int vouno)
        {
            ...
            if (vouno != 0)
            {
                string strSql = "Select * from masterpurchaseorderstockist where VoucherNumber = {0} ";
        ...
        public DataTable ReadProductDetailsByID(string Id)
        {
            ...
            if (Id != "")
            {
                string strsql = "Select distinct a.DSLID, a.MasterID, a.ProductID,0 as Quantity,a.OrderQuantity,a.SchemeQuantity,a.PurchaseRate as ProdLastPurchaseRate,a.ShortListDate,a.IfDailyShortList,a.CreateduserID,a.CreatedDate,a.CreatedTime, b.ProductID, b.ProdName,b.Prodloosepack,b.prodpack,b.ProdCompShortName,b.ProdClosingStock,b.ProdBoxQuantity, a.OrderQuantity*a.PurchaseRate as Amount, 0 as sale " +
                                    "from detailpurchaseorder a inner join masterproduct b  on a.ProductID = b.ProductID where  a.MasterID = '{0}' ";
        ...
        public DataTable ReadProductDetailsByIDForPurchase(string Id)
        {
            ...
            if (Id != "")
            {
                string strsql = "Select distinct a.DSLID, a.MasterID, a.ProductID,0 as Quantity,a.OrderQuantity,a.SchemeQuantity,a.ShortListDate,a.IfDailyShortList,a.CreateduserID,a.CreatedDate,a.CreatedTime, b.ProductID, b.ProdName,b.Prodloosepack,b.prodpack,b.ProdCompShortName,b.ProdClosingStock,b.ProdBoxQuantity, a.OrderQuantity*a.PurchaseRate as Amount, 0 as sale, " +
                                    "b.ProdLastPurchaseVATPer,b.ProdIFBarcodeRequired,b.ProdLastPurchaseRate,b.ProdLastPurchaseTradeRate,b.ProdLastPurchaseSaleRate,b.ProdLastPurchaseDistributorSaleRatePer,b.ProdLastPurchaseDistributorSaleRate,b.ProdLastPurchaseMRP,b.ProdLastPurchaseCSTPer,ProdLastPurchaseCST,ProdLastPurchaseExpiry,ProdLastPurchaseExpiryDate,ProdLastPurchaseBatchNumber,ProdLastPurchaseStockID   from detailpurchaseorderstockist a inner join masterproduct b  on a.ProductID = b.ProductID where  a. MasterID = '{0}' ";
        ...
        public DataTable ReadProductDetailsByAccountID(string AccountId , string fromDate, string toDate)
        {
          ...
          "b.ProdPartyId_1,b.ProdPartyId_2,b.ProdMinLevel,b.ProdMaxLevel,b.ProdClosingStock,b.ProdMaxLevel - b.ProdClosingStock as OrderQuantity ,b.ProdLastPurchaseRate,0 as quantity  from detailpurchaseorderstockist a " +
        ...
        public DataTable ReadProductDetailsAllTypesAccountIDWise(string fromDate, string toDate)
        {
            ...
            string strSql = "Select a.DSLID,a.OrderNumber,a.OrderDate,a.ShortListDate,a.OrderQuantity,a.IfSave,a.AccountID,e.AccName,b.ProductID,b.ProdName,b.ProdLoosePack,b.ProdPack,b.ProdBoxQuantity,b.ProdCompShortName," +
          "b.ProdPartyId_1,b.ProdPartyId_2,b.ProdMinLevel,b.ProdMaxLevel,b.ProdClosingStock,b.ProdMaxLevel - b.ProdClosingStock as OrderQuantity ,b.ProdLastPurchaseRate,0 as quantity  from detailpurchaseorder a " +
        ...
        {
            string strsql = "Update detailpurchaseorderstockist set accountID = '" + accountID + "' where dslID = '" + dslID + "'";
        ...
        {
            DataTable dtable = new DataTable();
            string strSql = "Select ID,VoucherType,VoucherSeries,VoucherNumber,VoucherDate,AccountID,Amount from masterpurchaseorderstockist  where AccountId = '"+ accountID +"' order by vouchernumber ";
            dtable = DBInterface.SelectDataTable(strSql);
            return dtable;
        }
    }
