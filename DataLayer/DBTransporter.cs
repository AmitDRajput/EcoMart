...
namespace EcoMart.DataLayer
{
    class DBTransporter
    {
        ...
        public DataTable GetOverviewData()
        {
            ...
            string strSql = "Select ID, Name from mastertransport order by Name";
        ...
        public DataRow ReadDetailsByID(int Id)
        {
            ...
            if (Id != 0)
            {
                string strSql = "Select * from mastertransport where ID= '{0}' ";
        ...
        public bool AddDetails(string Id, string Name, string Address1, string Address2, string Telephone, string MobileNumberForSMS, string MailID, string createdby, string createddate, string createtime)
        {
        ...
        private string GetDataForUniqueForAdd(string Name, string Id)
        {
            ...
            sQuery.AppendFormat("Select SalesmanId from mastertransport where SalesmanName='{0}'", Name);
            if (Id != "")
            {
        ...
        private string GetInsertQuery(string Id, string Name, string Address1, string Address2, string Telephone, string MobileNumberForSMS, string MailID, string createdby, string createddate, string createdtime)
        {
            Query objQuery = new Query();
            objQuery.Table = "mastertransport";
