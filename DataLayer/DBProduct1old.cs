    ...
    public class DBProduct1
    {
        ...
        public DataTable GetOverviewData()
        {
            ...
            string strsql = "Select a.ProductID,a.ProdName,a.ProdPack,a.ProdPackType,a.ProdLoosePack,floor(a.ProdClosingStock/a.ProdLoosePack) as ProdClosingStockPack," +
                            ...
                            "a.ProdMaxLevel,a.ProdLastSaleStockID,a.ProdLastPurchaseStockID,a.tag,a.ProdDrugID,b.ShelfID,b.ShelfCode,c.CompID,c.CompName,d.GenericCategoryName, 0 as  lastSaleMRP from masterproduct a  left outer join mastershelf b  on a.ProdShelfID = b.ShelfID  inner join mastercompany c on a.ProdCompId = c.CompId left outer join mastergenericcategory d on a.ProdDrugID = d.GenericCategoryID  order by a.ProdName";
        ...
        public DataTable GetOverviewData(double vatPercent)
        {
            ...
            string strsql = "Select a.ProductID,a.ProdName,a.ProdPack,a.ProdPackType,a.ProdLoosePack,floor(a.ProdClosingStock/a.ProdLoosePack) as ProdClosingStockPack," +
                            "a.ProdCompShortName,a.ProdBoxQuantity,a.ProdVATPercent,a.ProdCST,a.ProdGrade,a.ProdCompID,a.ProdLastPurchaseMRP,a.ProdLastPurchaseSaleRate," +
                            "a.ProdShelfID,a.ProdScheduleDrugCode,a.ProdIfSchedule,a.ProdOpeningStock,a.ProdClosingStock ,a.ProdIfSaleDisc,a.ProdLastPurchaseRate,a.ProdIfShortListed,a.ProdRequireColdStorage,a.ProdMRP, " +
                            "a.ProdMaxLevel,a.ProdLastSaleStockID,a.ProdLastPurchaseStockID,a.tag,a.ProdDrugID,b.ShelfID,b.ShelfCode,c.CompID,c.CompName,d.GenericCategoryName, 0 as  lastSaleMRP from masterproduct a  left outer join mastershelf b  on a.ProdShelfID = b.ShelfID  inner join mastercompany c on a.ProdCompId = c.CompId left outer join mastergenericcategory d on a.ProdDrugID = d.GenericCategoryID  where a.ProdVatPercent = "+ vatPercent +" order by a.ProdName";
        ...
        public bool UpdateSaleStockInmasterProduct(string Id,  int Quantity,string stockid, string voutype, int vouno, string voudate, string accountid, string scancode, double mrp)
        {
            bool returnVal = false;
        ...
        public bool UpdatePurchaseDataInmasterProduct(string ProductID, string PurchaseBillNumber, string VoucherDate, string AccountID, string VoucherType,
                ...
                double AmountSchemeDiscount, double ItemDiscountPercent, string Expiry, string ExpiryDate, string Batchno,string shelfID, string stockid , double distSaleRatePer , double distributorSaleRate)
        {
            bool returnVal = false;
            string strSql = GetUpdateQueryforlastpurchase(ProductID, PurchaseBillNumber, VoucherDate, AccountID, VoucherType,
                   ...
                   AmountSchemeDiscount, ItemDiscountPercent, Expiry, ExpiryDate, Batchno, shelfID, stockid, distSaleRatePer, distributorSaleRate);
        ...
        public bool UpdatePurchaseOrder(string ProductID, int Quantity)
        {
            bool returnVal = false;
