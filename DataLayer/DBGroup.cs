...
namespace EcoMart.DataLayer
{
    public class DBGroup
    {
        ...
        public DataTable GetOverviewData()
        {
            ...
            string strSql = "Select GroupName, GroupId,GroupCode,UnderGroupId,IFMainGroup from MasterGroup  where levelNumber != 28 and levelNumber != 31 and IfMainGroup != 'Y' order by GroupName";
        ...
        {
            DataTable dtable = new DataTable();
            string strSql = "Select GroupName,GroupId,GroupCode,UnderGroupId,IFMainGroup,IFFIX,UnderGroupIdParentID from MasterGroup where  UnderGroupIdParentID < 20  and levelNumber != 28 and levelNumber != 31 order by GroupName ";
            dtable = DBInterface.SelectDataTable(strSql);
            return dtable;
        }
        ...
        {
            DataTable dtable = new DataTable();
            string strSql = "Select GroupName, GroupId,GroupCode,UnderGroupId,IFMainGroup,IFFIX from MasterGroup where  IfMainGroup != 'Y' and IfMainGroup != 'X' order by GroupName ";
            dtable = DBInterface.SelectDataTable(strSql);
            return dtable;
        }
