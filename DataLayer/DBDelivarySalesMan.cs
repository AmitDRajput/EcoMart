...
{
    class DBDelivarySalesMan
    {
        public DBDelivarySalesMan()
        {
        }
        ...
        public DataTable GetOverviewData()
        {
            ...
            string strSql = "Select ID, Name from masterdelivarysalesman order by Name";
        ...
        public DataRow ReadDetailsByID(int Id)
        {
            ...
            if (Id != 0)
            {
                string strSql = "Select * from masterdelivarysalesman where ID= '{0}' ";
        ...
        private string GetDataForUniqueForAdd(string Name, string Id)
        {
            ...
            sQuery.AppendFormat("Select ID from masterdelivarysalesman where SalesmanName='{0}'", Name);
            if (Id != "")
            {
        ...
        private string GetInsertQuery(string Name, string Address1, string Address2, string Telephone, string MobileNumberForSMS, string MailID, string createdby, string createddate, string createdtime)
        {
            ...
            objQuery.Table = "masterdelivarysalesman";
