...
namespace EcoMart.DataLayer
{
    public class DBCorrection
    {
        ...
        public bool AddDetails(string stockid, int ProductID , string BatchNumber, string Expiry,
        ...
        private string GetInsertQuery(string stockid, int ProductID, string BatchNumber, string Expiry,
        ...
        public bool AddDetailsInVoucherCorrection(string ID, string Oldstockid, string NewStockID, int Vouchernumber, string Voucherdate, int ProductID, string OldBatch, string OldExpiry,
        ...
        private string GetInsertQueryInVoucherCorrection(string ID, string Oldstockid, string NewStockID, int Vouchernumber, string Voucherdate, int ProductID, string OldBatch, string OldExpiry,
                    double OldMRP, double OldPurchaseRate, double OldSellRate, int OldQty,
        ...
        public DataRow SearchForNewBatchAndMrpIntblStock(int ProductIDId, string NewBatch, double  NewMrp)
        {
            DataRow dr = null;
