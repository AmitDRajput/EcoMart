...
namespace EcoMart.DataLayer
{
    public class DBScheme
    {
        ...
        public DataRow ReadDetailsByProductID(int Id)
        {
            DataRow dRow = null;
        ...
        public bool AddDetails(string Id, int ProductID, string startdate, string closingdate, int qty1, int scm1, int qty2, int scm2, int qty3, int scm3, string createdby, string createddate, string createdtime)
        {
        ...
        public bool UpdateDetails(string Id, int ProductID, string startdate, string closingdate, int qty1, int scm1, int qty2, int scm2, int qty3, int scm3, string modifyby, string modifydate, string modifytime)
        {
            bool bRetValue = false;
        ...
        private string GetInsertQuery(string Id, int ProductID, string startdate, string closingdate, int qty1, int scm1, int qty2, int scm2, int qty3, int scm3, string createdby, string createddate, string createdtime)
        {
        ...
        private string GetUpdateQuery(string Id, int ProductID, string startdate, string closingdate, int qty1, int scm1, int qty2, int scm2, int qty3, int scm3, string modifyby, string modifydate, string modifytime)
        {
            Query objQuery = new Query();
            objQuery.Table = "Masterscheme";
