...
namespace EcoMart.DataLayer
{
    public class DBChallanPurchase
    {
        ...
        public bool AddDetailsProductsSS(string Id, string ChallanNumber, string VoucherDate, int VoucherNumber, string ProductID, string Batchno, double TradeRate, double PurchaseRate, double MRP, double SaleRate,
        ...
        private string GetInsertQueryDetails(string Id, string ChallanNumber, string VoucherDate, int ChallanVoucherNumber, string ProductID, string Batchno, double TradeRate, double PurchaseRate, double MRP, double SaleRate,
               string Expiry, string ExpiryDate, int Quantity, int SchemeQuantity, int ReplacementQuantity, double ItemDiscountPercent, double AmountItemDiscount, double SchemeDiscountPercent,
               double AmountSchemeDiscount, double PurchaseVATPercent, double ProductVATPercent, double AmountPurchaseVAT, double AmountProductVAT, double CSTPercent, double AmountCST, string IfMRPInclusiveOfVAT,
