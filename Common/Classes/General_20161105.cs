...
namespace PharmaSYSRetailPlus.Common
{
    public static class General
    {
        ...
        public static string ApplicationTitle = "Paperless Pharma Retail";
        ...
        public static string ProdID = "";  // [ansuman]
        public static string SubstituteProductID = ""; // [ansuman]
  public static BackupPath BackupPath;
       ...
       // public static string PharmaSYSVersion = "3.0.2"; // 12/10/2016  Sale with Product Discount
        ...
        public static PharmaSYSRetailPlus.Printing.PrintSettingsForDistributor PrintSettingsForDistributor;
        ...
        internal static string GetShortDateInyyyymmddForm(string shortdt)
        {
            ...
            if (expdt != "")
            {
                string yy = Convert.ToString(Convert.ToInt32(expdt.Substring(6, 2)) + 2000);
                string mm = expdt.Substring(3, 2);
                string dd = expdt.Substring(0, 2);
                expdt = yy + mm + dd;
            }
