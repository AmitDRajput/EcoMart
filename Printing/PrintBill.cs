...
namespace PrintDataGrid
{
    class PrintBill
    {
        ...
        public static void Print_Bill()
        {
            ...
            //PrintThread = new System.Threading.Thread(new System.Threading.ThreadStart (Print_BillData));
            //PrintThread.Start();
            Print_BillData();
        }
        private static void Print_BillData()
        {
        ...
        {
            //System.Threading.Thread PrintThread;
            //PrintThread = new System.Threading.Thread(() => Print_BillData(PageWidth, PageHeight));
            //PrintThread.Start();
            Print_BillData(PageWidth, PageHeight);
        }

        public static void Print_BillData(int PageWidth, int PageHeight)
        {
          //  PrintPreviewDialog ppvw;
          //  // ss
            //CoolPrintPreview.CoolPrintPreviewDialog ppvw;
