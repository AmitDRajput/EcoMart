...
namespace EcoMart.Printing
{
    ...
    public enum PrintSettingsType
    {
        ...
        CashBankPrintSettingsPlainPaper = 5,
        CashBankPringSettingsPrePrintedPaper = 6,
        StockOutPrintSettingsPlainPaper = 7,
        StockOutPrintSettingsPrePrintedPaper = 8,
    }
    ...
    public class PrintSettings
    {
        ...
        private SaleBillSettings _CashBankPrintSettingsPlainPaper;
        public SaleBillSettings CashBankPrintSettingsPlainPaper
        {
            get { return _CashBankPrintSettingsPlainPaper ; }
        }
        private SaleBillSettings _CashBankPrintSettingsPrePrintedPaper;
        public SaleBillSettings CashBankPrintSettingsPrePrintedPaper
        {
            get { return _CashBankPrintSettingsPrePrintedPaper; }
        }
        private SaleBillSettings _StockOutPrintSettingsPlainPaper;
        public SaleBillSettings StockOutPrintSettingsPlainPaper
        {
            get { return _StockOutPrintSettingsPlainPaper; }
        }
        private SaleBillSettings _StockOutPrintSettingsPrePrintedPaper;
        public SaleBillSettings StockOutPrintSettingsPrePrintedPaper
        {
            get { return _StockOutPrintSettingsPrePrintedPaper; }
        }
        public PrintSettings()
        {
            ...
            _CashBankPrintSettingsPlainPaper = new SaleBillSettings(PrintSettingsType.CashBankPrintSettingsPlainPaper);
            _CashBankPrintSettingsPrePrintedPaper = new SaleBillSettings(PrintSettingsType.CashBankPringSettingsPrePrintedPaper);
            _StockOutPrintSettingsPlainPaper = new SaleBillSettings(PrintSettingsType.StockOutPrintSettingsPlainPaper);
            _StockOutPrintSettingsPrePrintedPaper = new SaleBillSettings(PrintSettingsType.StockOutPrintSettingsPrePrintedPaper);
            ReadPrintSettings();
        ...
        private void ReadPrintSettings()
        {
            try
            {
                ...
                _CashBankPrintSettingsPlainPaper.ReadSettings(doc);
                _CashBankPrintSettingsPrePrintedPaper.ReadSettings(doc);
                _StockOutPrintSettingsPlainPaper.ReadSettings(doc);
                _StockOutPrintSettingsPrePrintedPaper.ReadSettings(doc);
            }
            catch (Exception ex)
            {
        ...
        public static string GetRootElementName(PrintSettingsType settingsType)
        {
            ...
            switch (settingsType)
            {
                ...
                case PrintSettingsType.DebitNotePrintSettingsPrePrintedPaper:
                    ...
                    break;
                case PrintSettingsType.CashBankPrintSettingsPlainPaper:
                    retValue = "CashBankPrintSettingsPlainPaper";
                    break;
                case PrintSettingsType.CashBankPringSettingsPrePrintedPaper:
                    retValue = "CashBankPrintSettingsPrePrintedPaper";
                    break;
                case PrintSettingsType.StockOutPrintSettingsPlainPaper:
                    retValue = "StockOutPrintSettingsPlainPaper";
                    break;
                case PrintSettingsType.StockOutPrintSettingsPrePrintedPaper:
                    retValue = "StockOutPrintSettingsPrePrintedPaper";
                    break;
    ...
    public class PageHeader
    {
        ...
        private PageItem _VoucherTypeStockIn;
        public PageItem VoucherTypeStockIn
        {
            get { return _VoucherTypeStockIn; }
            set { _VoucherTypeStockIn = value; }
        }
        private PageItem _VoucherTypeStockOut;
        public PageItem VoucherTypeStockOut
        {
            get { return _VoucherTypeStockOut; }
            set { _VoucherTypeStockOut = value; }
        }
        private PageItem _VoucherTypeCashReceipt;
        public PageItem VoucherTypeCashReceipt
        {
            get { return _VoucherTypeCashReceipt; }
            set { _VoucherTypeCashReceipt = value; }
        }
        private PageItem _VoucherTypeCashPayment;
        public PageItem VoucherTypeCashPayment
        {
            get { return _VoucherTypeCashPayment; }
            set { _VoucherTypeCashPayment = value; }
        }
        private PageItem _VoucherTypeBankReceipt;
        public PageItem VoucherTypeBankReceipt
        {
            get { return _VoucherTypeBankReceipt; }
            set { _VoucherTypeBankReceipt = value; }
        }
        private PageItem _VoucherTypeBankPayment;
        public PageItem VoucherTypeBankPayment
        {
            get { return _VoucherTypeBankPayment; }
            set { _VoucherTypeBankPayment = value; }
        }
        ...
        public PageHeader(PrintSettingsType printSettingsType)
        {
            ...
            _VoucherTypeStockIn = new PageItem();
            _VoucherTypeStockOut = new PageItem();
            _VoucherTypeCashReceipt = new PageItem();
            _VoucherTypeCashPayment = new PageItem();
            _VoucherTypeBankReceipt = new PageItem();
            _VoucherTypeBankPayment = new PageItem();
        ...
        public void ReadSettings(XDocument doc)
        {
            try
            {
                ...
                foreach (XElement element in doc.Descendants(rootElement).Descendants("PageHeader"))
                {
                    ...
                    item = element.Element("VoucherTypeStockOUTItem");
                    _VoucherTypeStockOut.ReadSettings(item);

                    item = element.Element("VoucherTypeStockINItem");
                    _VoucherTypeStockIn.ReadSettings(item);

                    item = element.Element("VoucherTypeCashReceiptItem");
                    _VoucherTypeCashReceipt.ReadSettings(item);

                    item = element.Element("VoucherTypeCashPaymentItem");
                    _VoucherTypeCashPayment.ReadSettings(item);

                    item = element.Element("VoucherTypeBankReceiptItem");
                    _VoucherTypeBankReceipt.ReadSettings(item);

                    item = element.Element("VoucherTypeBankPaymentItem");
                    _VoucherTypeBankPayment.ReadSettings(item);
    ...
    public class PageFooter
    {
        ...
        private PageItem _DeclarationItem1;
        public PageItem DeclarationItem1
        {
            get { return _DeclarationItem1; }
            set { _DeclarationItem1 = value; }
        }
        private PageItem _DeclarationItem2;
        public PageItem DeclarationItem2
        {
            get { return _DeclarationItem2; }
            set { _DeclarationItem2 = value; }
        }
        private PageItem _DeclarationItem3;
        public PageItem DeclarationItem3
        {
        ...
        private PageItem _JurisdictionItem;
        public PageItem JurisdictionItem
        {
            get { return _JurisdictionItem; }
            set { _JurisdictionItem = value; }
        }

        private PageItem _ATOWItem;
        public PageItem ATOWItem
        {
            get { return _ATOWItem; }
            set { _ATOWItem = value;}                
        }
        ...
        public PageFooter(PrintSettingsType printSettingsType)
        {
            ...
            _JurisdictionItem = new PageItem();
            _ATOWItem = new PageItem();
            _DLNItem = new PageItem();
            _VATTINItem = new PageItem();
            _ShopNameItem = new PageItem();
            _DeclarationItem1 = new PageItem();
            _DeclarationItem2 = new PageItem();
            _DeclarationItem3 = new PageItem();
        ...
        public void ReadSettings(XDocument doc)
        {
            try
            {
                ...
                foreach (XElement element in doc.Descendants(rootElement).Descendants("PageFooter"))
                {
                    ...
                    item = element.Element("JurisdictionItem");
                    _JurisdictionItem.ReadSettings(item);

                    item = element.Element("ATOWItem");
                     _ATOWItem.ReadSettings(item);
                    ...
                    _DeclarationItem1.ReadSettings(item);

                    item = element.Element("DeclarationItem2");
                    _DeclarationItem2.ReadSettings(item);

                    item = element.Element("DeclarationItem3");
                    _DeclarationItem3.ReadSettings(item);
