namespace EcoMart.InterfaceLayer.CommonControls
{
    partial class PSMainSubViewControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.dgMainGrid = new EcoMart.InterfaceLayer.CommonControls.PSMainGridView();
            ...
            this.dgMainGrid.OnCellTextChanged += new EcoMart.InterfaceLayer.CommonControls.PSMainGridView.CellTextChanged(this.dgMainGrid_OnCellTextChanged);
            this.dgMainGrid.OnCellValueChangeCommited += new EcoMart.InterfaceLayer.CommonControls.PSMainGridView.CellValueChangeCommited(this.dgMainGrid_OnCellValueChangeCommited);
            this.dgMainGrid.OnArrowUpDownPressed += new EcoMart.InterfaceLayer.CommonControls.PSMainGridView.ArrowUpDownPressed(this.dgMainGrid_OnArrowUpDownPressed);
            this.dgMainGrid.OnArrowLeftRightPressed += new EcoMart.InterfaceLayer.CommonControls.PSMainGridView.ArrowLeftRightPressed(this.dgMainGrid_OnArrowLeftRightPressed);
        ...
        public PSMainGridView dgMainGrid;
