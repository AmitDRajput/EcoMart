...
namespace EcoMart.InterfaceLayer.CommonControls
{
    ...
    internal class PSProductMainGridViewForBillReprint : DataGridView
    {
        ...
        public PSProductMainGridViewForBillReprint()
            : base()
        {
        ...
        protected override bool ProcessCmdKey(ref Message msg, Keys keyData)
        {
            ...
            try
            {
                ...
                if (key.KeyCode == Keys.Enter)
                {
                    ...
                    if (NumericColumnNames.Contains(this.CurrentCell.OwningColumn.Name))
                    {
                        int intValue;
                        int.TryParse(this.CurrentCell.Value.ToString(), out intValue);
                        this.CurrentCell.Value = intValue.ToString("0");
                    }
                    else if (DoubleColumnNames.Contains(this.CurrentCell.OwningColumn.Name))
                    {
                        double doubleValue;
                    ...
                    if (this.CurrentCell.Value != null && this.CurrentCell.Value.ToString() != "")
                    {
                        ...
                        { 
                            ...
                            SetCurrentCell(newRowId, 0);
                            if (OnRowAdded != null)
                                OnRowAdded(this, new EventArgs());
                        }
                        else if (IsNewRowColumn()) // ss 09/08/2013 && IsCurrentCellInEditMode == true
                        {
