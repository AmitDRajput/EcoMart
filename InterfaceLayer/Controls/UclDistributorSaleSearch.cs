...
namespace EcoMart.InterfaceLayer
{
    ...
    public partial class UclDistributorSaleSearch : SearchControl
    {
        #region Declaration
        private DataTable _BindingSource;
        private SSSale _DistributorSale;
        private string _SubType;

        #endregion Declaration

        #region Constructor
        public UclDistributorSaleSearch(string subType)
        {
            try
            {
                _SubType = subType;
        ...
        private void FillSearchGridData()
        {
            try
            {
                ...
                dtable = _DistributorSale.GetDistributorSaleOverviewData(_SubType);
