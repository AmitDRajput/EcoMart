...
namespace PharmaSYSDistributorPlus.InterfaceLayer
{
    ...
    public partial class UclSpecialSaleSearch : SearchControl
    {
        #region Declaration
        ...
        private void FillSearchGridData()
        {
            try
            {
                ...
                // dtable = _SSSale.GetOverviewDataSpecialSale(FixAccounts.SubTypeForPatientSale, General.ConvertDateToISODateString(dtFrom.Value), General.ConvertDateToISODateString(dtTo.Value));
                // _BindingSource = dtable;
                DataTable dtable = new DataTable();
                dtable = _SSSale.GetOverviewData(FixAccounts.SubTypeForPatientSale, General.ConvertDateToISODateString(dtFrom.Value), General.ConvertDateToISODateString(dtTo.Value));
                _BindingSource = dtable;
            }
            catch (Exception ex)
            {
        ...
        private void UclSpecialSaleSearch_Load(object sender, EventArgs e)
        {
