    ...
    public partial class UclSaleWithoutStock : BaseControl
    {
        ...
        public override bool Add()
        {
            ...
            try
            {
                ...
                InitializeScreen();
                headerLabel1.Text = "SALE WITHOUT STOCK -> NEW";                
        ...
        public override bool Edit()
        {
            ...
            {
                ClearData();
                headerLabel1.Text = "SALE WITHOUT STOCK -> EDIT";
                InitializeCheckBoxes();               
                FillPartyCombo();               
            }
            catch (Exception Ex)
        ...
        public override bool Delete()
        {
            ...
            try
            {
                headerLabel1.Text = "SALE WITHOUT STOCK -> DELETE";
                InitializeCheckBoxes();
                ClearData();
            }
            catch (Exception Ex)
        ...
        {
            htTableList = General.GetTableListVouchers("ID", "", 0, "W", General.ShopDetail.ShopVoucherSeries, "VoucherSale");
            bool retValue = base.View();
            try
            {
                ClearData();
                headerLabel1.Text = "SALE WITHOUT STOCK -> VIEW";
                InitializeCheckBoxes();
                MoveLast();
        ...
        public override bool MoveFirst()
        {
            ...
            if (htTableList.Contains(CurrentNumber))
                _SSSale.Id = htTableList[CurrentNumber].ToString();
        ...
        private void InitialisempPVC1(string vmode)
        {
            ...
            {     
                ...
                if (vmode == "C")
                {
                    ...
                    headerLabel1.Text = "SALE WITHOUT STOCK => Changed Voucher";
                    tsBtnPrint.Enabled = false;
                }
                else if (vmode == "D")
                {
                    dtable = _SSSale.ReadProductDetailsByIDForDeleted();
                    headerLabel1.Text = "SALE WITHOUT STOCK => Deleted Voucher";
                    tsBtnPrint.Enabled = false;
                }
                else
        ...
        {        
            ...
            try
            {
                ...
                // vat 5.5
                mvat5 = Math.Round((mamount5 * 6 / 100), 2);
                mvat12point5 = Math.Round((mamount12point5 * 13.5 / 100), 2);
