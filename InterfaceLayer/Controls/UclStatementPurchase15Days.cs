...
namespace EcoMart.InterfaceLayer
{
    ...
    public partial class UclStatementPurchase15Days : BaseControl
    {
        ...
        {
            PrintRow row;
            EcoMart.Printing.GeneralSettings generalPrintSettings;
        ...
        private void UclStatementPurchase15Days_Load(object sender, EventArgs e)
        {
