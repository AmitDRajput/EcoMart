...
namespace PharmaSYSRetailPlus.InterfaceLayer
{
    ...
    public partial class UclCounterSaleNegativeStock : BaseControl
    {
        #region Declaration
        ...
        #region Constructor
        public UclCounterSaleNegativeStock()
        {
            InitializeComponent();
            _SSSale = new SSSale();
        ...
        private void mpPVC6_OnRowAdded(object sender, EventArgs e)
        {
            ActiveDataGridOnRowAdded(sender);
        }
        private void mpPVC5_OnRowAdded(object sender, EventArgs e)
        {
            ActiveDataGridOnRowAdded(sender);
        }

        private void mpPVC4_OnRowAdded(object sender, EventArgs e)
        {
            ActiveDataGridOnRowAdded(sender);
        }

        private void mpPVC3_OnRowAdded(object sender, EventArgs e)
        {
            ActiveDataGridOnRowAdded(sender);
        }

        private void mpPVC2_OnRowAdded(object sender, EventArgs e)
        {
            ActiveDataGridOnRowAdded(sender);
        }
