...
{
    public partial class UclSaleWithProductDiscountSearch : SearchControl
    {
        #region Declaration
        ...
        #region Constructor
        public UclSaleWithProductDiscountSearch()
        {
            try
            {
                InitializeComponent();
        ...
        private void FillSearchGridData()
        {
            try
            {
                ...
                dtable = _DebtorSale.GetSaleWithProductDiscountOverviewData();
