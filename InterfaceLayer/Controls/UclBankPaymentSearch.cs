...
namespace EcoMart.InterfaceLayer
{
    ...
    public partial class UclBankPaymentSearch : SearchControl
    {
        ...
        private void FillSearchGridData()
        {
            ...
            try
            {
                dtable = _BankPayment.GetOverviewData(_BankPayment.CBVouType, General.ConvertDateToISODateString(dtFrom.Value), General.ConvertDateToISODateString(dtTo.Value));
