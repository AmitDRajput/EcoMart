...
namespace EcoMart.InterfaceLayer
{
    ...
    public partial class UclPurchaseOrderMinMax : BaseControl
    {
        #region Declaration
        ...
        public override bool Add()
        {
            ...
            try
            {
                ...
                headerLabel1.Text = "PURCHASE ORDER MIN MAX -> NEW";
        ...
        private int PrintHeader(int TotalPages, int Rowcount, Font fnt)
        {
            ...
            try
            {
                ...
                row = new PrintRow("Purchase Order :" + (_DailyPurchaseOrder.DSLFirstOrderNumber.ToString().Trim()), PrintRowPixel, 250, fnt);
                PrintBill.Rows.Add(row);
                ...
                PrintRowPixel = PrintRowPixel + 17;
                row = new PrintRow(_DailyPurchaseOrder.DSLAccountName, PrintRowPixel, 1, fnt);
                PrintBill.Rows.Add(row);
