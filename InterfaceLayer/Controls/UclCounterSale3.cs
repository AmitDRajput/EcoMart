...
namespace PharmaSYSDistributorPlus.InterfaceLayer
{
    ...
    public partial class UclCounterSale3 : BaseControl
    {
        #region Declaration
        ...
        public override bool Exit()
        {
            ...
            {               
                ...
                //ss    General.DeleteTempStockByModuleNumber(ModuleNumber.CounterSale);
                    UpdateClosingStockinCache();
                 //ss   mpPVC1.Rows.Clear();
                }
            }
            catch (Exception ex)
            {
        ...
        //////                {
        //////                    PharmaSYSDistributorPlus.Printing.PageColumn column;
        //////                    column = PageContent.Columns[i];
        //////                    if (column.ColumnDataType == PharmaSYSDistributorPlus.Printing.ColumnDataType.Integer)
        //////                    {
        ...
        //////                        }
        //////                    }
        //////                    else if (column.ColumnDataType == PharmaSYSDistributorPlus.Printing.ColumnDataType.Decimal)
        //////                    {
        ...
        //////    try
        //////    {
        //////        PharmaSYSDistributorPlus.Printing.PageHeader PageHeader = General.PrintSettings.SaleBillPrintSettingsPlainPaper.PageHeader;
        ...
        //ss    printer.Print(_SSSale.CrdbVouType, _SSSale.CrdbVouNo.ToString(), _SSSale.CrdbVouDate, _SSSale.ShortName, "", _SSSale.DoctorNameAddress, "", PrintGrid.Rows, _SSSale.CrdbNarration, _SSSale.CrdbAmountNet, _SSSale.SaleSubType, _SSSale.CrdbDiscAmt, _SSSale.CrNoteAmount, _SSSale.DbNoteAmount, _SSSale.CrdbAmount);
...
//                        PharmaSYSDistributorPlus.Printing.PageContent PageContent = General.PrintSettings.SaleBillPrintSettingsPrePrintedPaper.PageContent;
//                        for (int i = 0; i < PageContent.ColumnCount; i++)
//                        {
//                            PharmaSYSDistributorPlus.Printing.PageColumn column;
//                            column = PageContent.Columns[i];
...
//            try
//            {
//                PharmaSYSDistributorPlus.Printing.PageHeader PageHeader = General.PrintSettings.SaleBillPrintSettingsPrePrintedPaper.PageHeader;
...
//        }
        ...
        private void InitialisempPVC1()
        {
            ...
            //    mpPVC1.DataSourceProductList = PharmaSYSDistributorPlusCache.GetProductData();
                FormatGrids();
                mpPVC1.Bind();
            }
            catch (Exception ex)
