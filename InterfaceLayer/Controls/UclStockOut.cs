    ...
    public partial class UclStockOut : BaseControl
    {
        ...
        public override bool View()
        {
            ...
            try
            {
                ...
                FillPartyCombo();
                txtVouchernumber.Focus();
                //   if (General.IsUserRightAllowed(this. ,OperationMode.Add))
        ...
        private void PrintDebitNotePrePrintedPaper()
        {
            ...
            printer.Print(_StockOut.CrdbVouType, _StockOut.CrdbVouNo.ToString(), _StockOut.CrdbVouDate, "Stock OUT", _StockOut.CrdbAddress, "", "", "", mpPVC1.Rows, _StockOut.CrdbNarration, _StockOut.CrdbAmountNet, "", _StockOut.CrdbDiscAmt, 0, 0, _StockOut.CrdbAmount, 0 + _StockOut.CrdbAmountNet, "");
        ...
        private void PrintDebitNotePlainPaper()
        {
            ...
            printer.Print(_StockOut.CrdbVouType, _StockOut.CrdbVouNo.ToString(), _StockOut.CrdbVouDate, "Stock OUT", _StockOut.CrdbAddress, "", "", "", mpPVC1.Rows, _StockOut.CrdbNarration, _StockOut.CrdbAmountNet, "", _StockOut.CrdbDiscAmt, 0, 0, _StockOut.CrdbTotalAmount, 0 + _StockOut.CrdbAmountNet, "");
                    ...
                    foreach (DataGridViewRow prodrow in mpPVC1.Rows)
                    {
                           ...
                           Convert.ToDouble(prodrow.Cells["Col_Quantity"].Value) > 0)
                        {
                            ...
                            if (prodrow.Cells["Col_ExpiryDate"].Value != null)
                            {
                                ...
                                if (_StockOut.ExpiryDate.Length > 6)
                                    _StockOut.ExpiryDate = General.GetExpiryInyyyymmddForm(_StockOut.ExpiryDate);
                            }
                            // _StockOut.Expiry = prodrow.Cells["Col_Expiry"].Value.ToString();
                            //_StockOut.ExpiryDate = Convert.ToDateTime(prodrow.Cells["Col_ExpiryDate"].Value).ToString("yyyyMMdd"); 
                            //if (_StockOut.ExpiryDate != "")
                            //    _StockOut.ExpiryDate = General.GetExpiryInyyyymmddForm(_StockOut.Expiry);
        ...
        private void mpPVC1_OnBatchSelected(DataGridViewRow batchRow)
        {
            ...
            try
            {
                ...
                mpPVC1.MainDataGridCurrentRow.Cells["Col_SaleRate"].Value = mtraderate.ToString("#0.00");
        ...
        private void mpPVC1_OnCellValueChangeCommited(int colIndex)
        {
            try
            {
                ...
                if (colIndex == 10)
                    if (mpPVC1.MainDataGridCurrentRow.Cells[11].Value == null || mpPVC1.MainDataGridCurrentRow.Cells[11].Value.ToString() == string.Empty)
                        mpPVC1.MainDataGridCurrentRow.Cells[11].Value = "G";
