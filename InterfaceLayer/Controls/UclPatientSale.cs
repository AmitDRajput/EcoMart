    ...
    public partial class UclPatientSale : BaseControl
    {
        ...
        public UclPatientSale()
        {
            try
            {
                ...
                txtMobileNumber.Size = new Size(165, 25);
                CreatePatientSaleDt();
        ...
        public override bool Edit()
        {
            ...
            try
            {
                ...
                if (_Mode == OperationMode.Edit)
                    ...
                    headerLabel1.Text = "PATIENT SALE -> TYPE CHANGE";
                else
                            ...
                            if (_Mode != OperationMode.Fifth)
                            {
                                ...
                                if (ifstockavailable)
                                {
                                    if (_Mode == OperationMode.Add || _Mode == OperationMode.OpenAsChild)
                                    {
                                        ...
                                        {
                                            // UpdateClosingStockinCache();                                           
                                            HasShowSavedMessage(printData, Convert.ToDouble(txtNetAmount.Text.ToString()));
                                            //  RefreshProductGrid();
                                            retValue = true;
                                        }
                                        else
                                    ...
                                    else if (_Mode == OperationMode.Edit)
                                    {
                                        ...
                                        if (_SSSale.IfTypeChange == "Y")
                                        {
                                            ...
                                            if (retValue)
                                            {
                                                ...
                                                PSDialogResult result = PSMessageBox.Show("Information has been saved successfully.", msgLine2, General.ApplicationTitle, PSMessageBoxButtons.OK, PSMessageBoxIcon.Information, PSMessageBoxButtons.OK, Convert.ToDouble(txtNetAmount.Text.ToString()));
                                                retValue = true;
                                                //  RefreshProductGrid();
                                            }
                                            else
        ...
        private void HasShowSavedMessage(bool printData, double BillAmt)
        {
            ...
            if (printData)
            {
                ...
                Print();
               //Amar For Sms
                if (General.CurrentSetting.SmsSetPatientSale == "Y")
                {                   
                    SendSMS mSMS = new SendSMS();
                    string Msg = "Dear Customer,\n Your Bill No.:'" + _SSSale.CrdbVouNo + "' Of Amount :'" + _SSSale.CrdbAmountNet + "' Thank You For Dealing With Us.";
        ...
        private void TypeChangeMethod()
        {
            try
            {
                ...
                if (_Mode == OperationMode.Fifth)
                {
                    ...
                    _SSSale.IfTypeChange = "Y";
                    tsBtnSave.Enabled = true;
                    //btnClone.Enabled = btnSubstitute.Enabled = btnPreviousSale.Enabled = btnClearPatient.Enabled = false;
                }
                ...
                if (_SSSale.CrdbVouType == FixAccounts.VoucherTypeForCashSale)
                {
                    ...
                    cbTransactionType.Items.Add(FixAccounts.TransactionTypeForCreditCard); //Amar
        ...
        public override bool HandleShortcutAction(Keys keyPressed, Keys modifier)
        {
            ...
            try
            {
                ...
                {
                    BtnClearPatient();      //mcbDoctor.Focus();
                    retValue = true;
                }
                ...
                {
                    dgvLastPurchase.Visible = false;//pravin
                    ...
                    // {
                    //retValue = Exit();   // [commented by ansuman as per requirement] [04.11.2016]
                    //retValue = true;
                    //}
        ...
        public override string[] FillAllShortcutkeys()
        {
            ...
            ShortKeys[1] = "Clear Doctor --->  Alt + D";
            ShortKeys[2] = "Edit Rate -------->  Alt + E";
            ShortKeys[3] = "Similar Product -> Alt + M";
            ShortKeys[4] = "Pre. Sale ------->  Alt + P";
            ShortKeys[5] = "Clear Patient --->  Alt + R";
            ShortKeys[6] = "";
            ShortKeys[7] = "";
            ShortKeys[8] = "";
            ShortKeys[9] = "";
        ...
        private void ClearControls()
        {
            ...
            {
                FillPartyCombo();
                mpPVC1.ProductListGridWidth = 750; // Math.Max(ActiveDataGrid.Width - 350,690);
                ...
                mpPVC1.ProductListGridWidth = 750;
                ...
                txtAddOn.Text = "0.00";
                txtPendingBalance.Text = "0.00";      // [ansuman]
        ...
        private void FillTxtAddress()
        {
            try
            {
                txtAddress1.SelectedID = null;
                txtAddress1.SourceDataString = new string[2] { "AreaID", "AreaName" };
                txtAddress1.ColumnWidth = new string[2] { "0", "300" };
                txtAddress1.ValueColumnNo = 0;
                txtAddress1.UserControlToShow = new UclArea();
                Area _Area = new Area();
                ...
                foreach (DataRow dtrow in stkdt.Rows)
                {
                    ...
                    if (mactualsalestock > 0 && msalestk > 0 && mactualclosingstock > 0)
                    {
                        ...
                        if (msalestk > 0 && mactualclosingstock > 0)
                        {
                            ...
                            if (mpPVC1.Rows.Count == CurRowIndex)
                            {
                                //int curind = mpPVC1.Rows.Add();
                                //if (curind < mpPVC1.Rows.Count)
                                //    if (txtsavecustno.Text.ToString().Trim() == "1")
                                //        mpPVC1.Rows[curind].DefaultCellStyle.BackColor = btn1.BackColor;
                                //    else if (txtsavecustno.Text.ToString().Trim() == "2")
                                //        mpPVC1.Rows[curind].DefaultCellStyle.BackColor = btn2.BackColor;
                                //    else if (txtsavecustno.Text.ToString().Trim() == "3")
                                //        mpPVC1.Rows[curind].DefaultCellStyle.BackColor = btn3.BackColor;
                                //    else if (txtsavecustno.Text.ToString().Trim() == "4")
                                //        mpPVC1.Rows[curind].DefaultCellStyle.BackColor = btn4.BackColor;
                                //    else if (txtsavecustno.Text.ToString().Trim() == "5")
                                //        mpPVC1.Rows[curind].DefaultCellStyle.BackColor = btn5.BackColor;
                                //    else
                                //        mpPVC1.Rows[curind].DefaultCellStyle.BackColor = btn6.BackColor;
                            }
        ...
        private void CalculateRoundAmount()
        {
            ...
            double newpendingAmount=0.00;
            newpendingAmount = _SSSale.PendingAmount - _SSSale.PreAmountNet + Convert.ToDouble(txtNetAmount.Text.ToString());
            txtPendingBalance.Text = newpendingAmount.ToString("#0.00"); // [ansuman]
        }
        private void NoofRows()
        {
            ...
            try
            {
                ...
                UpdateTempPatientSaleDt();//pravin
            }
            catch (Exception Ex)
            {
                Log.WriteException(Ex);
        ...
        private void InitializeCheckBoxes()
        {
            try
            {
                ...
                if ((_Mode == OperationMode.Add || _Mode == OperationMode.Edit) && General.CurrentUser.Level <= 1)
        ...
        private void ConstructCreditNoteColumns()
        {
            ...
            dgCreditNote.SelectionMode = DataGridViewSelectionMode.FullRowSelect;
            try
            {
                DataGridViewTextBoxColumn column;
                //0
        ...
        private void mcbCreditor_SeletectIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                if (mcbCreditor.SelectedID != null && mcbCreditor.SelectedID != "")  // [ansuman]
                {
                    try
                    {
                    _SSSale.PatientID = mcbCreditor.SelectedID;
                    DataRow dr = _SSSale.GetDetailsByPatientID(mcbCreditor.SelectedID);
                ...
                if (mcbCreditor.SeletedItem == null && mcbCreditor.Text == "")
                {
                    ...
                    txtDiscPercent.Text = string.Empty;
                }
                else if (mcbCreditor.SeletedItem != null)
                {
                    ...
                    if (_SSSale.PendingAmount > 0)
                    {
                        txtPendingBalance.BackColor = Color.Orange;
                        txtPendingBalance.ForeColor = Color.Black;
                    }
                    else
                        txtPendingBalance.BackColor = Color.Snow;
        ...
        private void mpPVC1_OnProductSelected(DataGridViewRow productRow)
        {
            ...
            try
            {
                ...
                mpPVC1.MainDataGridCurrentRow.Cells["Col_SaleRate"].ReadOnly = !cbEditRate.Checked;//Pravin
                mpPVC1.MainDataGridCurrentRow.Cells["Col_Quantity"].ReadOnly = false;
                ...
                //  mclstk = mclstk + tempstock - totproductsale;   //commented by Amit, as mclstk is calculated runtime
        ...
        private bool mpPVC1_OnCanRowDeleted(object sender, EventArgs e)
        {
            bool retValue = true;
        ...
        private void mpPVC1OnRowDeleted(object sender)
        {
            try
            {
                ...
                lblFooterMessage.Text = "";
                lblRightSideFooterMsg.Text = "";
                //if (_SSSale.AddNewRowCheck(mpPVC1))//Pravin
                //    mpPVC1.Rows.Add();
                dgvLastPurchase.Visible = false;
                //    mpPVC1.SetFocus(1);
        ...
        private void mpPVC1CellValueChanged(int colIndex)
        {
            ...
            try
            {
                ...
                if (colIndex == 11) //Quantity
                {
                    ...
                    {
                        //pravin: copied from counter sale
            ...
            foreach (DataGridViewRow drp in mpPVC1.Rows)
            {
                         ...
                         drp.Cells["Col_MRP"].Value != null)
                {
                             ...
                             drp.Cells["Col_MRP"].Value.ToString().Trim() == mmrp.ToString("#0.00") && drp.Index != mcurrentindex)
                    {
                        ...
                        int currentBatchStk = _SSSale.CurrentBatchStock;
        ...
        private void mcbDoctor_EnterKeyPressed(object sender, EventArgs e)
        {
            ...
            {
                txtDoctorAddress.Text = mcbDoctor.SeletedItem.ItemData[2].ToString();
                mpPVC1.SetFocus(mpPVC1.Rows.Count - 1, 1);// mpPVC1.SetFocus(1);
            }
                else if (mcbDoctor.Text.ToString().Trim() != "")  //Amar
                {
        ...
        private void btnOKFill_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                this.ActiveControl = btnCanelFill;
                btnCanelFill.Focus();
            }
        }
        ...
        private void txtAddress2_KeyDown(object sender, KeyEventArgs e)
        {
            switch (e.KeyCode)
            {
                case Keys.Enter:
                    ...
                    break;
                case Keys.Up:
                    this.ActiveControl = txtAddress1;
                    txtAddress1.Focus();
                    break;
                case Keys.Down:
                    txtMobileNumber.Focus();
            ...
            try
            {
                ...
                switch (e.KeyCode)
                {
                    case Keys.Enter:
                        ...
                        {
                            //PSDialogResult result;
                            if (txtMobileNumber.Text != string.Empty && string.IsNullOrEmpty(Convert.ToString(mcbCreditor.SeletedItem)) == false)
                            {
                                if (mcbCreditor.SeletedItem.ItemData[9].ToString() == string.Empty)
                                {
                                    Patient _patient = new Patient();
                                    _patient.UpdateMobileNumberInMasterPatient(txtMobileNumber.Text, mcbCreditor.SelectedID);
                                }
                                else if (mcbCreditor.SeletedItem.ItemData[9].ToString() != txtMobileNumber.Text)
                                {
                                    PSMessageBox.Show("Number Not Valid.", "Update Mobile Number", PSMessageBoxButtons.OK, PSMessageBoxIcon.Information, PSMessageBoxButtons.OK);
                                    txtMobileNumber.Focus();
                                    return;
                                }
                            }
        ...
        private void txtTelephoneNumber_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                case Keys.Enter:
                    //    if (!System.Text.RegularExpressions.Regex.IsMatch(txtTelephoneNumber.Text, "^[0-9/,+-]+$")) // [ansuman] [17.11.2016]
                    //    {
                    //        txtTelephoneNumber.Focus();
        ...
        private void BtnClearPatient()
        {
            ...
            txtPendingBalance.Text = "0.00";
            btnPreviousSale.Enabled = false;
            this.ActiveControl = mcbCreditor;
            mcbCreditor.Focus();
        }
        private void btnClone_Click(object sender, EventArgs e)
        {
            if (pnlClone.Visible == false)
            {
        ...
        {
            if (e.KeyCode == Keys.Enter)
                if (mcbDoctor.Text.ToString().Trim() != "")
                {
                txtDoctorAddress.Focus();
        }
        }
        ...
        {
            mcbCreditor.Focus();    // [ansuman][17.11.2016]
            //txtTokenNumber.Focus();
        }
        ...
        protected override bool ProcessCmdKey(ref Message msg, Keys keyData) // [ansuman][17.11.2016]
        {
            bool retValue = false;
            try
            {
                if (this.ActiveControl == mcbDoctor)
                {
                    mcbDoctor.Text.ToUpper();
                }
            }
            catch { }
            return retValue;
        ...
        private void txtAddress2_UpArrowKeyPressed(object sender, EventArgs e) // [ansuman][17.11.2016]
        {
            txtAddress1.Focus();
        }

        private void txtAddress2_EnterKeyPressed(object sender, EventArgs e) // [ansuman][17.11.2016]
        {
        ...
        private void UpdateTempPatientSaleDt()
        {
            try
            {
                DataTable dtTempCounterSale = CreatePatientSaleDt();
