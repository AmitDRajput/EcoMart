...
namespace EcoMart.InterfaceLayer
{
    ...
    public partial class UclStockOutSearch : SearchControl 
    {
        # region declaration
        ...
        public override void ShowOverview()
        {
            try
            {
                ...
                headerLabelForOverView1.Text = "STOCK OUT -> SEARCH";
        ...
        private void FillSearchGridData()
        {
            try
            {
                ...
                dtable = _StockOut.GetOverviewData(_StockOut.CrdbVouType);
