...
namespace EcoMart.InterfaceLayer
{
    ...
    public partial class UclCustomer : BaseControl
    {
        ...
        {
            htTableList = General.GetTableListByCode("CustomerID", "CustomerNameAddress", "mastercustomer");
            bool retValue = false;
            try
            {
                retValue = base.View();
        ...
        public override bool MoveFirst()
        {
            ...
            if (htTableList.Contains(CurrentNumber))
                _Customer.Id = htTableList[CurrentNumber].ToString();
            FillSearchData(_Customer.Id, "");
        ...
        public override bool Save()
        {
            ...
            try
            {
                ...
                if (_Customer.IsValid)
                {
                    ...
                    {
                        _Customer.IntID  = _Customer.GetIntID(); /* Guid.NewGuid().ToString().ToUpper().Replace("-", "");*/
