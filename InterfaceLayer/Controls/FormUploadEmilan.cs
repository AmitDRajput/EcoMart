...
{
    public partial class FormUploadEmilan : Form
    {
        public DataTable emilandt;
        public FormUploadEmilan()
        {
            InitializeComponent();
        }
        ...
        public void BtnOKClick()
        {
            ...
            Emilan em = new Emilan();
            newdt.TableName = "OrderItems";
            try
            {
                foreach (DataGridViewRow dr in dgPurchaseOrder.Rows)
                {
                    if (dr.Cells["Col_Check"].Value.ToString() != string.Empty)
                    {
                        string masterid = "";
                        if (dr.Cells["Col_MasterID"].Value != null && dr.Cells["Col_MasterID"].Value.ToString() != string.Empty)
                        {
                ...
                orders.OrdersFromUserBulk(General.DeveloperId, General.UserId, General.Password, newdt);
