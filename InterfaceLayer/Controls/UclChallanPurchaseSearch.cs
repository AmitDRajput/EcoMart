...
namespace PharmaSYSDistributorPlus.InterfaceLayer
{
    ...
    public partial class UclChallanPurchaseSearch: SearchControl
    {
        #region Declaration
        ...
        # region Constructor
        public UclChallanPurchaseSearch()
        {
            try
            {
                InitializeComponent();
        ...
        public override void ShowOverview()
        {
            try
            {
                ...
                headerLabelForOverView1.Text = "CHALLANPURCHASE -> SEARCH";
        ...
        private void ConstructSearchColumns()
        {
            ...
            try
            {
                ...
                column = new DataGridViewTextBoxColumn();
                column.Name = "Col_chalBillNo";
                column.DataPropertyName = "challanNumber";
                column.HeaderText = "Chln Number";
                column.Width = 90;
                dgvSearchList.Columns.Add(column);
        ...
        private void FillSearchGridData()
        {
            try
            {
                ...
                dtable = _ChallanPurchase.GetOverviewData();
