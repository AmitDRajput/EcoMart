...
namespace EcoMart.InterfaceLayer
{
    ...
    public partial class UclGenericCategorySearch : SearchControl
    {
        #region Declaration
        ...
        #region Constructor
        public UclGenericCategorySearch()
        {
            try
            {
                InitializeComponent();
        ...
        public override void ShowOverview()
        {
            try
            {
                ...
                headerLabelForOverView1.Text = "GENERIC CATEGORY OVERVIEW";
        ...
        private void ConstructSearchColumns()
        {
            ...
            try
            {
                ...
                column.HeaderText = "Generic Category Name";
                column.Width = 580;
                dgvSearchList.Columns.Add(column);
            }
            catch (Exception ex)
        ...
        private void FillSearchGridData()
        {
            try
            {
                ...
                dtable = _GenericCategory.GetOverviewData();
