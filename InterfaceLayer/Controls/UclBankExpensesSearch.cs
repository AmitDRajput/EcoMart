...
namespace EcoMart.InterfaceLayer
{
    ...
    public partial class UclBankExpensesSearch : SearchControl
    {
        # region declaration
        ...
        public override void ShowOverview()
        {
            try
            {
                ...
                headerLabelForOverView1.Text = "BANK EXPENSES -> SEARCH";
        ...
        private void FillSearchGridData()
        {
            try
            {
                ...
                dtable = _BankExpenses.GetOverviewData(_BankExpenses.CBVouType, General.ConvertDateToISODateString(dtFrom.Value), General.ConvertDateToISODateString(dtTo.Value));
