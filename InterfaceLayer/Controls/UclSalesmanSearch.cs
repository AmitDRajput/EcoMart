//Description : This class contains all methods required for salesman master. This is user control required for 
...
namespace EcoMart.InterfaceLayer
{
    ...
    public partial class UclSalesmanSearch : SearchControl
    {
        #region Declaration
        ...
        public override void ShowOverview()
        {
            try
            {
                ...
                headerLabelForOverView1.Text = "SALESMAN -> SEARCH";
        ...
        private void ConstructSearchColumns()
        {
            ...
            try
            {
                ...
                column.Name = "Col_ID";
                column.DataPropertyName = "SalesmanID";
        ...
        private void FillSearchGridData()
        {
            try
            {
                ...
                dtable = _Salesman.GetOverviewData();
        ...
        private void dgvSearchList_Load(object sender, EventArgs e)
        {
