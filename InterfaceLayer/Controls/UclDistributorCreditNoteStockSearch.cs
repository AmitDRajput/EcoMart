...
namespace EcoMart.InterfaceLayer
{
    ...
    public partial class UclDistributorCreditNoteStockSearch : SearchControl
    {
        # region declaration
        ...
        # region Constructor
        public UclDistributorCreditNoteStockSearch()
        {
        try
            {
                InitializeComponent();
        ...
        public override void ShowOverview()
        {
            try
            {
                ...
                headerLabelForOverView1.Text = "CREDIT NOTE STOCK -> SEARCH";
        ...
        private void FillSearchGridData()
        {
            try
            {
                ...
                dtable = _CreditNoteStock.GetOverviewData(_CreditNoteStock.CrdbVouType);
