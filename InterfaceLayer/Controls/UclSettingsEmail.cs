...
namespace EcoMart.InterfaceLayer
{
    ...
    public partial class UclSettingsEmail : BaseControl
    {
        ...
        private void lnkLessSecureApp_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            Clipboard.SetText(lnkLessSecureApp.Text);
            MessageBox.Show("Link is copied in Clipboard", General.ApplicationTitle, MessageBoxButtons.OK);       
        }       
    }
}
