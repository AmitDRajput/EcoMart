...
namespace EcoMart.InterfaceLayer
{
    ...
    public partial class UclDelivaryBoySearch : SearchControl
    {
        #region Declaration
        ...
        public override void ShowOverview()
        {
            try
            {
                ...
                headerLabelForOverView1.Text = "DelivaryBoy -> SEARCH";
        ...
        private void ConstructSearchColumns()
        {
            ...
            try
            {
                ...
                column = new DataGridViewTextBoxColumn();
                column.Name = "Col_DelivaryBoyName";
                column.DataPropertyName = "Name";
                column.HeaderText = "Delivary Boy Name";
                column.Width = 580;
        ...
        private void FillSearchGridData()
        {
            try
            {
                ...
                dtable = _DelivaryBoy.GetOverviewData();
        ...
        private void dgvSearchList_DoubleClick(object sender, EventArgs e)
        {
