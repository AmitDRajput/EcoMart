...
namespace EcoMart.InterfaceLayer
{
    ...
    public partial class UclEmailIDSearch : SearchControl
    {
        #region Declaration
        ...
        public override void ShowOverview()
        {
            try
            {
                ...
                headerLabelForOverView1.Text = "EmailID -> SEARCH";
        ...
        private void ConstructSearchColumns()
        {
            ...
            try
            {
                ...
                column.Name = "Col_ID";
                column.DataPropertyName = "EmailID";
                column.HeaderText = "ID";
                column.Visible = false;
                dgvSearchList.Columns.Add(column);

                column = new DataGridViewTextBoxColumn();
                column.Name = "Col_EmailID";
                column.DataPropertyName = "EmailName";
        ...
        private void FillReportData()
        {
            try
            {
                ...
                dtable = _EmailID.GetOverviewData();
