...
namespace EcoMart.InterfaceLayer
{
    ...
    public partial class UclPurchaseOrderEcoMartSearch : SearchControl
    {
        # region declaration
        ...
        # region constructor
        public UclPurchaseOrderEcoMartSearch()
        {
            try
            {
                InitializeComponent();
        ...
        public override void ShowOverview()
        {
            try
            {
                ...
                headerLabelForOverView1.Text = "PURCHASE ORDER -> SEARCH";
        ...
        private void FillSearchGridData()
        {
            try
            {
                ...
                dtable = _PurchaseOrder.GetOverviewDataEcoMart();
