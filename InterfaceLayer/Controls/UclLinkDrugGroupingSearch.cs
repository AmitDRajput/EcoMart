...
namespace EcoMart.InterfaceLayer
{
    ...
    public partial class UclDrugGroupingSearch : SearchControl 
    {
        # region Declaration
        ...
        public override void ShowOverview()
        {
            try
            {
                ...
                headerLabelForOverView1.Text = "DRUG GROUPING -> SEARCH";
