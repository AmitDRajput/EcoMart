...
namespace EcoMart.Reporting.Controls
{
    ...
    public partial class UclDebitNoteStockOutListProduct : ReportBaseControl
    {
        # region Declaration
        private DataTable _BindingSource;
        private CreditDebitNote _CreditDebitNote;
        public string mvoutype = FixAccounts.VoucherTypeForStockOut;
        private string _MFromDate;
        private string _MToDate;
        # endregion

        #region Constructor
        public UclDebitNoteStockOutListProduct()
        {
            try
            {
                InitializeComponent();
        ...
        public override void ShowOverview()
        {
            try
            {
                ...
                headerLabel1.Text = "STOCK OUT LIST (PRODUCT)";
            ...
            {               
                ...
                foreach (DataGridViewRow dr in dgvReportList.Rows)
                {
                    ...
                    if (dr.Cells["Col_ID"].Value != null)
                    {
                        ...
                        PrintBill.Rows.Add(row);
                        row = new PrintRow(dr.Cells["Col_Narration"].Value.ToString(), PrintRowPixel, 530, PrintFont);
                        PrintBill.Rows.Add(row);
                    }
                }
                PrintRowPixel += 17;
        ...
        private int PrintHead()
        {
            ...
            try
            {
                ...
                PrintBill.Rows.Add(row);
                row = new PrintRow("Narration", PrintRowPixel, 530, PrintFont);
                PrintBill.Rows.Add(row);
