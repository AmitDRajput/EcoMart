...
namespace PharmaSYSDistributorPlus.Reporting.Controls
{
    ...
    public partial class UclLBTPurchaseParywise : ReportBaseControl
    {
        #region Declaration
        ...
        private double _MPurchaseAmount;

        #endregion

        # region Constructor
        public UclLBTPurchaseParywise()
        {
            try
            {
                InitializeComponent();
        ...
        public override void ShowOverview()
        {
            try
            {
                ...
                headerLabel1.Text = "LBT PURCHASE PARTYWISE BILLS";
                ClearControls();
                FillPartyCombo();
                AddToolTip();
                HidepnlGO();
        ...
        private void PrintData()
        {
            ...
            {               
                ...
                row = new PrintRow("Purchase Amount:"+_MPurchaseAmount.ToString("#0.00"), PrintRowPixel, colpix, PrintFont);
                PrintBill.Rows.Add(row);
                mlen = (_MTotalAmount.ToString("#0.00").Length);
                colpix = Convert.ToInt32(650.00 + ((12.00 - Convert.ToDouble(mlen)) * 5.5));
        ...
        public void ClearControls()
        {
            try
            {
                ...
                txtLBTTotalAmount.Text = "";
                txtPurchaseTotalAmount.Text = "";
                txtViewText.Text = "";
        ...
        private void FillReportGrid()
        {
            ...
            try
            {
                ...
                foreach (DataGridViewRow dr in dgvReportList.Rows)
                {
                    ...
                    {
                        prevouno = vouno;
                        _MPurchaseAmount += Convert.ToDouble(dr.Cells["Col_Purchase"].Value.ToString());
                    }
                    _MTotalAmount += Convert.ToDouble(dr.Cells["Col_LBT"].Value.ToString());
                }
                txtLBTTotalAmount.Text = _MTotalAmount.ToString("#0.00");
                txtPurchaseTotalAmount.Text = _MPurchaseAmount.ToString("#0.00");
                NoofRows();
                dgvReportList.Focus();
            }
            catch (Exception ex)
        ...
        private void FillReportData()
        {
            try
            {
                ...
                dtable = _Purchase.GetOverviewDataForLBTPurchasePartywise(mcbCreditor.SelectedID, _MFromDate, _MToDate);
        ...
        private void btnOKMultiSelectionClick()
        {
            ...
            try
            {
                ...
                if (retValue)
                {
                    ...
                    ShowReportGrid();
                    PrintReportHead = "LBT Purchase Partywise  From : " + General.GetDateInDateFormat(_MFromDate) + " To : " + General.GetDateInDateFormat(_MToDate);
