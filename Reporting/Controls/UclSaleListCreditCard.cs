...
namespace EcoMart.Reporting.Controls
{
    ...
    public partial class UclSaleListCreditCard : ReportBaseControl
    {
        #region Declaration
        ...
        public override void Print()
        {
            try
            {
                ...
                reportHeading += "Sale CreditCard From : " + General.GetDateInDateFormat(_MFromDate) + " To : " + General.GetDateInDateFormat(_MToDate);
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            try
            {
                PrintReportHead = "Sale CreditCard From : " + General.GetDateInDateFormat(_MFromDate) + " To : " + General.GetDateInDateFormat(_MToDate);
                PrintReportHead2 = "";
                FillReportGrid();
            }
            catch (Exception ex)
