...
namespace EcoMart.Reporting.Controls
{
    ...
    public partial class UclSaleListPartywiseOutstanding : ReportBaseControl
    {
        #region Declaration
        ...
        private string _MSaleSubType = "D";
        #endregion

        # region Constructor
        public UclSaleListPartywiseOutstanding()
        {
            try
            {
                InitializeComponent();
        ...
        public override void ShowOverview()
        {
            try
            {
                ...
                headerLabel1.Text = "SALE-PARTYWISE OUTSTANDING";
                ClearControls();
                FillPartyCombo();
                AddToolTip();
                fromDate1.Focus();
        ...
        private void BindReportList()
        {
            ...
            try
            {
                if (_BindingSource.Rows.Count > 0)
                {
                    ...
                    {
                        balanceamt = 0;  
                        curraccountID = dr["AccountID"].ToString(); // [AccountID => ID => AccountID] [ansuman-13.4.2017]
                    ...
                    if (dr["AmountBalance"] != DBNull.Value && dr["AmountBalance"].ToString() != string.Empty)
                        ...
                        if (balanceamt > 0)
                        {
                            ...
                            //totalnoofbills += 1;  [ansuman13.4.2017]
