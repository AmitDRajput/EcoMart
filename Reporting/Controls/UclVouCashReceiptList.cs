...
namespace EcoMart.Reporting.Controls
{
    ...
    public partial class UclVouCashReceiptList : ReportBaseControl
    {
        # region Declaration
        ...
        public override void ShowOverview()
        {
            try
            {
                ...
                headerLabel1.Text = "VOUCHER LIST-CASH RECEIPT";
                ClearControls();
                FillPartyCombo();
        ...
        public void ClearControls()
        {
            try
            {
                ...
                _VouType = FixAccounts.VoucherTypeForCashReceipt;
                txtViewtext.Enabled = false;
                txtViewAmount.Enabled = false;
                txtAmount.Text = "0.00";
        ...
        private void FillReportData()
        {
            try
            {
                ...
                dtable = _CashReceipt.GetOverviewData(_VouType, _MFromDate, _MToDate);
        ...
        private void btnOKMultiSelectionClick()
        {
            ...
            try
            {
                ...
                if (retValue)
                {
                    ...
                    FillReportGrid();
                    ShowpnlGO();
                    PrintReportHead = "Cash Receipts From: " + General.GetDateInShortDateFormat(_MFromDate) + " To: " + General.GetDateInShortDateFormat(_MToDate);
                    PrintReportHead2 = "";
