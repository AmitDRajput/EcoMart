...
namespace PharmaSYSDistributorPlus.Reporting.Controls
{
    ...
    public partial class UclLBTPurchaseFromInside : ReportBaseControl
    {
        #region Declaration
        ...
        # region Constructor
        public UclLBTPurchaseFromInside()
        {
            try
            {
                InitializeComponent();
        ...
        public override void ShowOverview()
        {
            try
            {
                ...
                headerLabel1.Text = "LBT PURCHASE FROM WITHIN";
                ClearControls();              
                AddToolTip();
                HidepnlGO();
                fromDate1.Focus();
        ...
        private void FillReportData()
        {
            try
            {
                ...
                dtable = _Purchase.GetOverviewDataForLBTPurchaseWITHIN(_MFromDate, _MToDate);
        ...
        private void btnOKMultiSelectionClick()
        {
            ...
            try
            {
                ...
                if (retValue)
                {
                    ...
                    ShowReportGrid();
                    PrintReportHead = "LBT Purchase From Within  From : " + General.GetDateInDateFormat(_MFromDate) + " To : " + General.GetDateInDateFormat(_MToDate);
                    PrintReportHead2 = " ";
