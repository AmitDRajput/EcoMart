namespace EcoMart.Reporting.Controls
{
    partial class UclPurchaseListCategory
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.txtTotItemDiscount = new EcoMart.InterfaceLayer.CommonControls.PSLableWithBorderMiddleRight(this.components);
            this.txtTotSplDiscount = new EcoMart.InterfaceLayer.CommonControls.PSLableWithBorderMiddleRight(this.components);
            this.txtTotScmDiscount = new EcoMart.InterfaceLayer.CommonControls.PSLableWithBorderMiddleRight(this.components);
            this.txtTotCashDiscount = new EcoMart.InterfaceLayer.CommonControls.PSLableWithBorderMiddleRight(this.components);
        ...
        private EcoMart.InterfaceLayer.CommonControls.PSLableWithBorderMiddleRight txtTotCashDiscount;
        private EcoMart.InterfaceLayer.CommonControls.PSLableWithBorderMiddleRight txtTotScmDiscount;
        private EcoMart.InterfaceLayer.CommonControls.PSLableWithBorderMiddleRight txtTotSplDiscount;
        private EcoMart.InterfaceLayer.CommonControls.PSLableWithBorderMiddleRight txtTotItemDiscount;
