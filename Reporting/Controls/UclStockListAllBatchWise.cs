...
namespace EcoMart.Reporting.Controls
{
    ...
    public partial class UclStockListAllBatchWise : ReportBaseControl
    {
        # region Declaration
        ...
        # region Constructor
        public UclStockListAllBatchWise()
        {
            try
            {
                InitializeComponent();
            ...
            {                
                ...
                foreach (DataGridViewRow dr in dgvReportList.Rows)
                {
                    ...
                    if (dr.Cells["Col_ProductName"].Value != null)
                    {
                        ...
                        if (dr.Cells["Col_BatchNumber"].Value != null)
                        {
                            row = new PrintRow(dr.Cells["Col_BatchNumber"].Value.ToString().PadLeft(6), PrintRowPixel, 350, PrintFont);
                            PrintBill.Rows.Add(row);
                        }
                        mamt = 0;
                        mcolpix = 400;
        ...
        private int PrintHead()
        {
            ...
            try
            {
                ...
                PrintBill.Rows.Add(row);
                row = new PrintRow("Batch", PrintRowPixel, 350, PrintFont);
                PrintBill.Rows.Add(row);
                int colpix = 460;
                if (rbtMRP.Checked)
                {
        ...
        private void FillReportData()
        {
            try
            {
                ...
                dtable = _Product.GetOverviewDataWithOutZeroAllProductsBatchWise();
        ...
        private void btnOKMultiSelectionClick()
        {
            ...
            FillReportGrid();
            PrintReportHead = "Product List [Batchwise] ";
            PrintReportHead2 = "";
