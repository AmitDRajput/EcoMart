...

{
    ...
    public partial class UclVouStatementPurchaseList : ReportBaseControl
    {
        # region Declaration
        ...
        # region Contructor
        public UclVouStatementPurchaseList()
        {
            try
            {
                InitializeComponent();
                ViewControl = new UclStatementPartywisePurchase();
            }
            catch (Exception ex)
            {
        ...
        public override void ShowOverview()
        {
            try
            {
                ...
                headerLabel1.Text = "VOUCHER LIST-STATEMENT PURCHASE";
                ClearControls();               
        ...
        public void ClearControls()
        {
            try
            {
                ...
                _VouType = FixAccounts.VoucherTypeForStatementPurchase;
            }
            catch (Exception ex)
            {
                Log.WriteException(ex);
        ...
        private void btnOKMultiSelectionClick()
        {
            ...
            try
            {
                ...
                if (retValue)
                {
                    ...
                    ShowpnlGO();
                    FillReportGrid();
                    PrintReportHead = "Statement Purchase From: " + General.GetDateInShortDateFormat(_MFromDate) + " To: " + General.GetDateInShortDateFormat(_MToDate);
                    PrintReportHead2 = "";
