...
namespace EcoMart.Reporting.Controls
{
    ...
    public partial class UclGSTSaleRegister : ReportBaseControl
    {
        #region Declaration
        private DataTable _BindingSource;
        private SSSale _Sale;
        ...
        public override void ShowOverview()
        {
            try
            {
                ...
                headerLabel1.Text = "GST - SALE REGISTER DETAIL";
                ClearControls();
                HidepnlGO();
                PrintReportHead = "GST SALE Register Detail  From: " + General.GetDateInShortDateFormat(_MFromDate) + " To: " + General.GetDateInShortDateFormat(_MToDate);
                PrintReportHead2 = " ";
                AddToolTip();
                txtMonth.Focus();
                ...
                foreach (DataRow dr in _BindingSource.Rows)
                {
                    ...
                    else
                    {
                        ...
                        if (dr["VATPer"] != DBNull.Value)
                            gstper = Convert.ToDouble(dr["VATPer"].ToString());
                        if (gstper == 0)
                        {
                        ...
                        {
                            dgvrow.Cells["Col_Amount5PercentS"].Value = dr["GSTSAmount"].ToString();
                            dgvrow.Cells["Col_GST5PercentS"].Value = dr["GSTS"].ToString();
                            dgvrow.Cells["Col_Amount5PercentC"].Value = dr["GSTCAmount"].ToString();
                        ...
                        {
                            dgvrow.Cells["Col_Amount18PercentS"].Value = dr["GSTSAmount"].ToString();
                            dgvrow.Cells["Col_GST18PercentS"].Value = dr["GSTS"].ToString();
                            dgvrow.Cells["Col_Amount18PercentC"].Value = dr["GSTCAmount"].ToString();
                            dgvrow.Cells["Col_GST18PercentC"].Value = dr["GSTC"].ToString();
                        }
                        else
                        {
                            dgvrow.Cells["Col_Amount28PercentS"].Value = dr["GSTSAmount"].ToString();
                            dgvrow.Cells["Col_GST28PercentS"].Value = dr["GSTS"].ToString();
                            dgvrow.Cells["Col_Amount28PercentC"].Value = dr["GSTCAmount"].ToString();
        ...
        private void FillReportData()
        {
            try
            {
                ...
                if (btnVoucherNumberWise.Checked == true)
                    dtable = _Sale.GetOverviewDataForGSTReport(_MFromDate, _MToDate);
                else
                    dtable = _Sale.GetOverviewDataForGSTReportHSN(_MFromDate, _MToDate);
