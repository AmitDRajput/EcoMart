...
namespace EcoMart.Reporting.Controls
{
    ...
    public partial class UclMISListDailyCashClosing : ReportBaseControl
    {
        #region Declaration
        ...
        # region Constructor
        public UclMISListDailyCashClosing()
        {
            try
            {
                InitializeComponent();
        ...
        public override void ShowOverview()
        {
            try
            {
                ...
                headerLabel1.Text = "MIS - DAILY CASH CLOSING";
                ClearControls();
                HidepnlGO();
                dgvReportList.Focus();
            }
        ...
        private void FillReportData()
        {
            try
            {
                ...
                dtable = _MPReports.GetDayTotalForDailyClosing(_MFromDate, _MToDate, FixAccounts.AccountCash.ToString());
        ...
        private void btnOKMultiSelectionClick()
        {
            ...
            try
            {
                ...
                if (retValue)
                {
                    ...
                    FillReportGrid();
                    PrintReportHead = "Daily Cash Closing From: " + General.GetDateInShortDateFormat(_MFromDate) + " To: " + General.GetDateInShortDateFormat(_MToDate);
                    PrintReportHead2 = "";
