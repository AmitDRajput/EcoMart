...
namespace EcoMart.Reporting.Controls
{
    ...
    public partial class UclMISListCurrentStockStatement : ReportBaseControl
    {
        #region Declaration
        ...
        # region Constructor
        public UclMISListCurrentStockStatement()
        {
            try
            {
                InitializeComponent();
        ...
        public override void ShowOverview()
        {
            try
            {
                ...
                headerLabel1.Text = "MIS - CURRENT STOCK STATEMENT";
                ClearControls();
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            {
                FillReportGrid();
                PrintReportHead = "Current Stock Statement Date : " + General.GetDateInDateFormat(_MFromDate);
                PrintReportHead2 = "";
            }
            catch (Exception ex)
            {
