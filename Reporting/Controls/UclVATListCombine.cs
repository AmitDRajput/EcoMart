...
namespace PharmaSYSDistributorPlus.Reporting.Controls
{
    ...
    public partial class UclVATListCombine : ReportBaseControl
    {
        ...
        private double _MTotalGRNetAmount;
        private double _MTotalGRNetVAT;
        //  private double _MTotalGRZero = 0;
        private double _MTotalGRAmount5 = 0;
        private double _MTotalGRVAT5 = 0;
        private double _MTotalGRAmount12point5 = 0;
        private double _MTotalGRVAT12point5 = 0;
        #endregion
        ...
        private void PrintData()
        {
            ...
            try
            {
                ...
                foreach (DataGridViewRow dr in dgvReportList.Rows)
                {
                    ...
                    if (dr.Cells["Col_NetAmount"].Value != null)
                    {
                        mamt = Convert.ToDouble(dr.Cells["Col_NetAmount"].Value.ToString());
                        mlen = (mamt.ToString("#0.00").Length);
        ...
        private int PrintHead()
        {
            ...
            try
            {
                ...
                PrintBill.Rows.Add(row);
                row = new PrintRow("Pur.6%VAT", PrintRowPixel, 200, PrintFont);
                PrintBill.Rows.Add(row);
                row = new PrintRow("VAT 6%", PrintRowPixel, 290, PrintFont);
                PrintBill.Rows.Add(row);
                row = new PrintRow("Pur.13.5%VAT", PrintRowPixel, 370, PrintFont);
                PrintBill.Rows.Add(row);
                row = new PrintRow("VAT 13.5%", PrintRowPixel, 460, PrintFont);
                PrintBill.Rows.Add(row);
                ...
                //PrintBill.Rows.Add(row);
                row = new PrintRow("NET VAT", PrintRowPixel, 550, PrintFont);
                PrintBill.Rows.Add(row);

                row = new PrintRow("NET Amount", PrintRowPixel, 670, PrintFont);
                PrintBill.Rows.Add(row);
                PrintRowPixel += 17;
        ...
        private void FormatReportGrid()
        {
            ...
            dgvReportList.DoubleColumnNames.Add("Col_NetAmount");
        }
        ...
        private void BindReportGrid()
        {
            ...
            _MTotalGRNetAmount = 0;
            _MTotalGRNetVAT = 0;
            //  private double _MTotalGRZero = 0;
            _MTotalGRAmount5 = 0;
            _MTotalGRVAT5 = 0;
            _MTotalGRAmount12point5 = 0;
            _MTotalGRVAT12point5 = 0;
            int mm = 0;
            int rowIndexo = 0;
            string yy = "";
            try
            {
                while (true)
                {
                    try
                    {
                        ...
                        foreach (DataRow dr in _BindingSourceSale.Rows)
                        {
                            ...
                            if (mm == currentmonth)
                            {
                                ...
                                dgvrow.Cells["Col_NetAmount"].Value = dr["AmountNet"].ToString();
                                nettotsale = Convert.ToDouble(dr["AmountNet"].ToString());
                                break;
                            }
                    ...
                    try
                    {
                        foreach (DataRow dr in _BindingSourceAllSalesReturn.Rows)
                        {
                            ...
                            if (mm == currentmonth)
                            {
                                ...
                                dgvrow.Cells["Col_NetAmount"].Value = dr["AmountNet"].ToString();
                                nettotcr = Convert.ToDouble(dr["AmountNet"].ToString());
                                ifsalesreturn = "Y";
                                break;
                    ...
                    dgvrow3.Cells["Col_NetAmount"].Value = (nettotsale - nettotcr).ToString("#0.00");
                    try
                    {
                        foreach (DataRow dr in _BindingSourcePurchase.Rows)
                        {
                            ...
                            if (mm == currentmonth)
                            {
                                ...
                                dgvrow.Cells["Col_NetAmount"].Value = dr["AmountNet"].ToString();
                                nettotpur = Convert.ToDouble(dr["AmountNet"].ToString());
                                break;
                            }
                    ...
                    dgvrow2.Cells["Col_NetAmount"].Value = (nettotsale - nettotcr - nettotpur).ToString("#0.00");
                    _MTotalGRNetAmount += (nettotsale - nettotcr - nettotpur);
                    _MTotalGRNetVAT += Math.Round((totsalevat5 - totsalesreturnvat5 - totpurchasevat5) + (totsalevat125 - totsalesreturnvat125 - totpurchasevat125), 2);
                    _MTotalGRAmount12point5 += (totsaleamt125 - totsalesreturnamt125 - totpurchaseamt125);
                    _MTotalGRAmount5 += (totsaleamt5 - totsalesreturnamt5 - totpurchaseamt5);
                    _MTotalGRVAT12point5 += (totsalevat125 - totsalesreturnvat125 - totpurchasevat125);
                    _MTotalGRVAT5 += (totsalevat5 - totsalesreturnvat5 - totpurchasevat5);
                    //   _MTotalGRZero = 
                    rowIndexo = dgvReportList.Rows.Add();
                    totpurchaseamt125 = 0;
                    totpurchaseamt5 = 0;
                ...
                rowIndexo = dgvReportList.Rows.Add();
                DataGridViewRow dgvrow4 = dgvReportList.Rows[rowIndexo];
                dgvrow4.Cells["Col_VoucherType"].Value = "Grand Net ";

                dgvrow4.Cells["Col_Amount5Percent"].Value = _MTotalGRAmount5.ToString();
                dgvrow4.Cells["Col_VAT5Percent"].Value = _MTotalGRVAT5.ToString();
                dgvrow4.Cells["Col_Amount12point5Percent"].Value = _MTotalGRAmount12point5.ToString();
                dgvrow4.Cells["Col_VAT12Point5Percent"].Value = _MTotalGRVAT12point5.ToString();
                dgvrow4.Cells["Col_NetVAT"].Value = _MTotalGRNetVAT.ToString();
                dgvrow4.Cells["Col_NetAmount"].Value = _MTotalGRNetAmount.ToString();
            }
            catch (Exception Ex)
            {
                Log.WriteException(Ex);
