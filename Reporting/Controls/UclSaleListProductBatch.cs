...
namespace EcoMart.Reporting.Controls
{
    ...
    public partial class UclSaleListProductBatch : ReportBaseControl
    {
        ...
        private void btnOKMultiSelectionClick()
        {
            ...
            try
            {
                ...
                if (retValue)
                {
                    ...
                    PrintReportHead = "Sales Report[Product/Batch]"; // From: " + General.GetDateInShortDateFormat(_MFromDate) + " To: " + General.GetDateInShortDateFormat(_MToDate); // Modified On [06.02.2017]
                    PrintReportHead2 = "";
                    NoofRows();
                    dgvReportList.Focus();
                }
        ...
        {
            DataTable dtable = new DataTable();
            dtable = _SaleList.GetSaleDataForGivenProductBatchMrp(Convert.ToInt32(mcbProduct.SelectedID), batch, mrp, fromDate, toDate);
