...
namespace EcoMart.Reporting.Controls
{
    ...
    public partial class UclAcListDebtorLedger : ReportBaseControl
    {
        #region Declaration
        ...
        public override void ShowOverview()
        {
            try
            {
                ...
                headerLabel1.Text = "ACCOUNT - DEBTORS' LEDGER";
                ClearControls();
                FillPartyCombo();
                FillVoucherTypes();
        ...
        private void ShowReportGrid()
        {
            InitializeReportGrid();
            ShowpnlGO();
            FillDataForOneAccount(mcbCreditor.SelectedID);
        }
        ...
        private void btnOKMultiSelectionClick()
        {
            ...
            try
            {
                ...
                if (retValue)
                {
                    ...
                    InitializeReportGrid();
                    ShowpnlGO();
                    PrintReportHead = "DEBTOR'S LEDGER From: " + General.GetDateInShortDateFormat(_MFromDate) + " To: " + General.GetDateInShortDateFormat(_MToDate);
                    PrintReportHead2 = "";
                    ...
                    if (mcbCreditor.SelectedID != null && mcbCreditor.SelectedID != string.Empty)
                    {
                        ...
                        FillDataForOneAccount(_MAccountID);
        ...
        private void FillDataForOneAccount(string accountID)
        {
            bool foundintrnac = true;
        ...
        private void FillPartyCombo()
        {
            try
            {
                ...
                DataTable dtable = _Party.GetSSAccountHoldersList("D");
        ...
        private void FillMultiSelectionData()
        {
            try
            {
                ...
                _Account = new Account();
                dtable = _Account.GetSSAccountHoldersListForMultiSelection(FixAccounts.AccCodeForDebtor);
        ...
        private void UclAcListDebtorLedger_Load(object sender, EventArgs e)
        {
            cbWithZeroTransactions.Checked = true;
        }
    }
}
