...
namespace EcoMart.Reporting.Controls
{
    ...
    public partial class UclCreditNoteStockInList : ReportBaseControl
    {
        # region Declaration
      ...
      //  private string _VouType;
        ...
        #region Constructor
        public UclCreditNoteStockInList()
        {
            try
            {
                InitializeComponent();                
        ...
        public override void ShowOverview()
        {
            try
            {
                ...
                headerLabel1.Text = "STOCK IN LIST";
        ...
        private void FillReportData()
        {
            try
            {
                ...
                dtable = _StockIn.GetOverviewDataStockIN(_MFromDate, _MToDate);
        ...
        private void btnOKMultiSelectionClick()
        {
            ...
            try
            {
                ...
                if (retValue)
                {
                    ...
                    FillReportGrid();
                    PrintReportHead = "STOCK IN LIST From: " + General.GetDateInShortDateFormat(_MFromDate) + " To: " + General.GetDateInShortDateFormat(_MToDate);
                    PrintReportHead2 = "";     
