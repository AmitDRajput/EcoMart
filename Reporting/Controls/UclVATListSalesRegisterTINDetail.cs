...
namespace PharmaSYSDistributorPlus.Reporting.Controls
{
    ...
    public partial class UclVATListSalesRegisterTINDetail : ReportBaseControl
    {
        #region Declaration
        ...
        # region Constructor
        public UclVATListSalesRegisterTINDetail()
        {
            try
            {
                InitializeComponent();
        ...
        private void FillReportData()
        {
            try
            {
                ...
                dtable = _SaleList.GetDataForVATRegisterTINDetail(_MFromDate, _MToDate);
        ...
        private void BindReportGrid()
        {
            try
            {
                foreach (DataRow dr in _BindingSource.Rows)
                {
                    ...
                    dgvrow.Cells["Col_ZeroVAT"].Value = dr["AmountForZeroVAT"].ToString();
                }
            }
            catch (Exception Ex)
            {
        ...
        private void dgvReportList_DoubleClicked(object sender, EventArgs e)
        {
            try
            {
                if (dgvReportList.SelectedRow != null && dgvReportList.Rows.Count > 0)
                {
                    ...
                    else if (VouSubType == FixAccounts.SubTypeForDistributorSale)
