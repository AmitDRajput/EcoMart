...
namespace PharmaSYSDistributorPlus.Reporting.Controls
{
    ...
    public partial class UclLBTPurchaseFromOutside : ReportBaseControl
    {
        #region Declaration
        ...
        # region Constructor
        public UclLBTPurchaseFromOutside()
        {
            try
            {
                InitializeComponent();
            ...
            try
            {
             ...
             //   if (mcbCreditor.SelectedID != null && mcbCreditor.SelectedID != "")
               //     dtable = _Purchase.GetOverviewDataForLBTPurchaseOUT(mcbCreditor.SelectedID, _MFromDate, _MToDate);
                    //dtable = _Purchase.GetOverviewDataForLBTPurchaseOUT(_MFromDate, _MToDate);
