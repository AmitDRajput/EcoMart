...
namespace EcoMart.Reporting.Controls
{
    ...
    public partial class UclCashExpenseSalaryList : ReportBaseControl
    {
        ...
        public override void Export(string ExportFileName)
        {
            ...
            PrintReportHead = "Cash Expense Salary From: " + General.GetDateInShortDateFormat(_MFromDate) + " To: " + General.GetDateInShortDateFormat(_MToDate);
            PrintReportHead2 = " ";
            try
            {
        ...
        public override void EMail(string EmailID)
        {
            ...
            {
                GeneralReport.ExportPrintHeader(PrintReportHead, PrintReportHead2, filePath);
                GeneralReport.EmailPrintDetails(dgvReportList, filePath, EmailID, PrintReportHead);
            }
            catch (Exception Ex)
            {
                Log.WriteException(Ex);
