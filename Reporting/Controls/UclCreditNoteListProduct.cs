...
namespace EcoMart.Reporting.Controls
{
    ...
    public partial class UclCreditNoteListProduct : ReportBaseControl
    {
        # region Declaration
        private DataTable _BindingSource;     
        private CreditDebitNote _CreditDebitNote;
        public string mvoutype = FixAccounts.VoucherTypeForCreditNoteStock;
        private string _MFromDate;
        private string _MToDate;
        # endregion

        #region Constructor
        public UclCreditNoteListProduct()
        {
            try
            {
                InitializeComponent();
        ...
        public override void ShowOverview()
        {
            try
            {
                ...
                headerLabel1.Text = "CREDIT NOTE LIST (PRODUCT)";
        ...
        private void btnOKMultiSelectionClick()
        {
            ...
            try
            {
                ...
                if (retValue)
                {
                    ...
                    FillReportGrid();
                    PrintReportHead = "CREDIT NOTE LIST [PRODUCT] From: " + General.GetDateInShortDateFormat(_MFromDate) + " To: " + General.GetDateInShortDateFormat(_MToDate);
                    PrintReportHead2 = "";
