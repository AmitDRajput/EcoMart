    ...
    public partial class UclStockListAll : ReportBaseControl
    {
        ...
        private void ConstructProductColumns()
        {
            try
            {
                ...
                column.Width = 90;
                column.AutoSizeMode = DataGridViewAutoSizeColumnMode.None;
                if (rbtMRP.Checked == true && rbtClosingStock.Checked != true)
                    column.Visible = true;
                else
                    column.Visible = false;               
                column.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
                ...
                column.Width = 90;
                column.AutoSizeMode = DataGridViewAutoSizeColumnMode.None;               
                if (rbtPurhcaseRate.Checked == true && rbtClosingStock.Checked != true)
                    column.Visible = true;
                else
                    column.Visible = false;
                column.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
                ...
                column.Width = 90;                
                column.AutoSizeMode = DataGridViewAutoSizeColumnMode.None;
                if (rbtMRP.Checked == true && rbtOpeningStock.Checked != true)
                    column.Visible = true;
                else
                    column.Visible = false;
                column.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
                ...
                column.Width = 90;
                column.AutoSizeMode = DataGridViewAutoSizeColumnMode.None;
                if (rbtPurhcaseRate.Checked == true && rbtOpeningStock.Checked != true)
                    column.Visible = true;
                else
                    column.Visible = false;                
                column.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
        ...
        private void FillReportData()
        {
            try
            {
                ...
                if (cbWithZeroStock.Checked != true)
                    dtable = _Product.GetOverviewDataWithOutZeroAllProducts();
                else
                    dtable = _Product.GetOverviewDataWithZeroAllProducts();
