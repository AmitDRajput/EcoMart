...
namespace EcoMart.Reporting.Controls
{
    ...
    public partial class UclSaleListPartyProduct : ReportBaseControl
    {
        #region Declaration
        ...
        # region Constructor
        public UclSaleListPartyProduct()
        {
            try
            {
                InitializeComponent();
        ...
        public override void ShowOverview()
        {
            try
            {
                ...
                headerLabel1.Text = "PARTY/PRODUCT";
        ...
        public override void Print()
        {
            try
            {
                ...
                reportHeading += "Sale Party Product From : " + General.GetDateInDateFormat(_MFromDate) + " To : " + General.GetDateInDateFormat(_MToDate);
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            try
            {
                PrintReportHead = "Sale Party Product From : " + General.GetDateInDateFormat(_MFromDate) + " To : " + General.GetDateInDateFormat(_MToDate);
                PrintReportHead2 = "";
                FillReportGrid();
            }
            catch (Exception ex)
