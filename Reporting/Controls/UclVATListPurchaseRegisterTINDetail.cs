...
namespace PharmaSYSDistributorPlus.Reporting.Controls
{
    ...
    public partial class UclVATListPurchaseRegisterTINDetail : ReportBaseControl
    {
         #region Declaration
        ...
        private double _MTotal12point5;
        private double _MTotalZeroVAT;
        #endregion

        # region Constructor
        public  UclVATListPurchaseRegisterTINDetail()
        {  
                try
                {
                    InitializeComponent();
        ...
        public override void ShowOverview()
        {
            try
            {
                ...
                headerLabel1.Text = "VAT - PURCHASE REGISTER TINWISE DETAIL";                
                ClearControls();
                PrintReportHead = "";
                PrintReportHead2 = "";
                HidepnlGO();
        ...
        private void ConstructReportColumns()
        {
            try
            {
                ...
                column = new DataGridViewTextBoxColumn();
                column.Name = "Col_ZeroVAT";
                column.HeaderText = "Amount Zero VAT";
                column.Width = 100;
                column.DefaultCellStyle.Format = "N2";
                column.HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleRight;
                column.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
        ...
        private void FillReportData()
        {
            try
            {
                ...
                dtable = _Purchase.GetOverviewDataForVATReportTINDetail(_MFromDate, _MToDate);
            ...
            try
            {
                foreach (DataRow dr in _BindingSource.Rows)
                {
                 ...
                 //   dgvrow.Cells["Col_Address"].Value = dr["AccAddress1"].ToString();
                    dgvrow.Cells["Col_ZeroVAT"].Value = dr["AmountPurchaseZeroVAT"].ToString();
                }
            }
            catch (Exception Ex)
            {
        ...
        private void CalculateFinalTotals()
        {
            ...
            foreach (DataGridViewRow dr in dgvReportList.Rows)
            {
                ...
                _MTotalZeroVAT += Convert.ToDouble(dr.Cells["Col_ZeroVAT"].Value.ToString());
                _MTotal5 += Convert.ToDouble(dr.Cells["Col_TotalVAT5Per"].Value.ToString());
                _MTotal12point5 += Convert.ToDouble(dr.Cells["Col_TotalVAT12.5Per"].Value.ToString());
            }
            int rowIndex = dgvReportList.Rows.Add();
            DataGridViewRow dgvrow = dgvReportList.Rows[rowIndex];
            ...
            dgvrow.Cells["Col_ZeroVAT"].Value = _MTotalZeroVAT.ToString("#0.00");
            dgvrow.Cells["Col_TotalVAT5Per"].Value = _MTotal5.ToString("#0.00");
            dgvrow.Cells["Col_TotalVAT12.5Per"].Value = _MTotal12point5.ToString("#0.00");
        }
