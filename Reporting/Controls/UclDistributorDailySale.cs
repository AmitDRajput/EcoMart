...
namespace EcoMart.Reporting.Controls
{
    ...
    public partial class UclDistributorDailySale : ReportBaseControl
    {
        #region Declaration
        ...
        # region Constructor
        public UclDistributorDailySale()
        {
            try
            {
                InitializeComponent();
        ...
        public override void ShowOverview()
        {
            try
            {
                ...
                dgvReportList.Bind();
                headerLabel1.Text = "DISTRIBUTOR DAILY SALE";
                ClearControls();
                HidepnlGO();
            ...
            {               
                ...
                foreach (DataGridViewRow dr in dgvReportList.Rows)
                {
                    ...
                    if (dr.Cells["Col_ID"].Value != null)
                    {
                        ...
                        PrintBill.Rows.Add(row);
                        row = new PrintRow(dr.Cells["Col_AccName"].Value.ToString().PadRight(35).Substring(0,35), PrintRowPixel, 160, PrintFont);
                        PrintBill.Rows.Add(row);
                        row = new PrintRow(dr.Cells["Col_Address"].Value.ToString().PadRight(30), PrintRowPixel, 400, PrintFont);
                        PrintBill.Rows.Add(row);
        ...
        private int PrintHead()
        {
            ...
            try
            {
                ...
                PrintBill.Rows.Add(row);
                row = new PrintRow("Address", PrintRowPixel, 400, PrintFont);
                PrintBill.Rows.Add(row);
        ...
        private void FillReportData()
        {
            ...
            {
                InitializeReportGrid();
                _BindingSource = _SaleList.GetOverviewDataForDailySaleReportDistributor(_MFromDate);
            }
            catch (Exception ex)
            {
                Log.WriteException(ex);
        ...
        private void CheckFilter()
        {
            try
            {
                if (rbtnCash.Checked == true)
                {
                 ...
                 //   _BindingSource.DefaultView.RowFilter = "VoucherType = '" + FixAccounts.VoucherTypeForDistributorSaleCash + "'";
                }
             ...
             //       _BindingSource.DefaultView.RowFilter = "VoucherType = '" + FixAccounts.VoucherTypeForDistributorSaleCreditStatement + "'";
                }
                else if (rbtnCredit.Checked == true)
                {
                    //  txtType.Text = FixAccounts.VoucherTypeForCreditPurchase;
                    txtViewtype.Text = "Credit";
                //    _BindingSource.DefaultView.RowFilter = "VoucherType = '" + FixAccounts.VoucherTypeForDistributorSaleCredit + "'";
                }
                else
                {
                    //   txtType.Text = "";
        ...
        private void BtnOKMultiselectionClick()
        {
            ...
            try
            {
                ...
                if (retValue)
                {
                    ...
                    ShowpnlGO();
                    FillReportGrid();
                    PrintReportHead = "Daily Sale Distributor Date : " + General.GetDateInDateFormat(_MFromDate);
                    PrintReportHead2 = "";
                    this.Cursor = Cursors.Default;
                    dgvReportList.Focus();
                }
