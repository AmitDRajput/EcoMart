...
namespace EcoMart.Reporting.Controls
{
    ...
    public partial class UclSaleListAdmitPatient : ReportBaseControl
    {
        #region Declaration
        ...
        # region Constructor
        public UclSaleListAdmitPatient()
        {
            try
            {
                InitializeComponent();
        ...
        public override void ShowOverview()
        {
            try
            {
                ...
                headerLabel1.Text = "HOSPITAL- ADMITED PATIENT";
                ClearControls();
        ...
        public override void Print()
        {
            try
            {
                ...
                reportHeading += "Sale Admit Patient From : " + General.GetDateInDateFormat(_MFromDate) + " To : " + General.GetDateInDateFormat(_MToDate);
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            try
            {
                PrintReportHead = "Sale Admit Patient From : " + General.GetDateInDateFormat(_MFromDate) + " To : " + General.GetDateInDateFormat(_MToDate);
                PrintReportHead2 = "";
                FillReportGrid();
            }
            catch (Exception ex)
