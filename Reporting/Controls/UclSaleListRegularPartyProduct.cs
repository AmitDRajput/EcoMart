...
namespace EcoMart.Reporting.Controls
{
    ...
    public partial class UclSaleListRegularPartyProduct : ReportBaseControl
    {
        #region Declaration
        ...
        # region Constructor
        public UclSaleListRegularPartyProduct()
        {
            try
            {
                InitializeComponent();
        ...
        public override void ShowOverview()
        {
            try
            {
                ...
                headerLabel1.Text = "SALE REGULAR PARTY";
                ClearControls();
                HidepnlGO();
                AddToolTip();
        ...
        public void ShowpnlGO()
        {
            ...
            txtViewParty.Text = mcbCreditor.SeletedItem.ItemData[2].Trim() + " " + mcbCreditor.SeletedItem.ItemData[3];
            dgvReportList.Focus();
        }
        ...
        private void BindReportGrid(string AccID, string party, string UOM, string Pack, string comp)
        {
            try
            {
                ...
                currentdr.Cells["Col_Batch"].Value = (party.Trim() + " " + UOM + " " + Pack + " " + comp);
                //currentdr.Cells["Col_VoucherNumber"].Value = (party.Trim() + " " + UOM + " " + Pack + " " + comp).Substring(10, 12);
                //currentdr.Cells["Col_VoucherDate"].Value = (party.Trim() + " " + UOM + " " + Pack + " " + comp).Substring(21);
                ...
                currentdr.Cells["Col_ID"].Value = AccID;
                currentdr.Cells["Col_VoucherType"].Value = (party.Trim() + " " + UOM + " " + Pack + " " + comp).Substring(0, 10);
                //if ((party.Trim() + " " + UOM + " " + Pack + " " + comp) != null)
                //currentdr.Cells["Col_VoucherNumber"].Value = (party.Trim() + " " + UOM + " " + Pack + " " + comp).Substring(10,12);
                //if ((party.Trim() + " " + UOM + " " + Pack + " " + comp).Substring(21) != null) ;
                //currentdr.Cells["Col_VoucherDate"].Value = (party.Trim() + " " + UOM + " " + Pack + " " + comp).Substring(21);
                currentdr.Cells["Col_ProductName"].Value = party.Trim() + " " + UOM + " " + Pack + " " + comp;
        ...
        private void FillPartyCombo()
        {
            try
            {
                ...
                mcbCreditor.SourceDataString = new string[8] { "PatientID", "AccCode", "PatientName", "PatientAddress1", "PatientAddress2", "ShortNameAddress", "DoctorID", "AccTransactionType" };
        ...
        //            }
        //        }
        //        txtNoofRowsSelected.Enabled = true;
        //        txtNoofRowsSelected.Text = i.ToString("#0");
        //        txtNoofRowsSelected.Enabled = false;
        //        txtSearch.Text = "";
        ...
        private void btnOKMultiSelectionClick()
        {
            ...
            try
            {
                ...
                if (retValue)
                {
                    ...
                    PrintReportHead = "Sales Report [Party/Products]"; // From: " + General.GetDateInShortDateFormat(_MFromDate) + " To: " + General.GetDateInShortDateFormat(_MToDate);
        ...
        private void AddToolTip()
        {
            try
            {
                ttSaleRegularPartyProduct.SetToolTip(txtSearch, "Type First Few characters of Product Name and Press Enter");
                ttSaleRegularPartyProduct.SetToolTip(cbSelectAll, "Check to Select All Products in the List and Click OK");
                ttSaleRegularPartyProduct.SetToolTip(btnViewList, "Click to View List of Selected Products and Click Again to Close the List");
                ttSaleRegularPartyProduct.SetToolTip(pnlMultiSelection1, "F12 to Reopen This Form");
            }
            catch (Exception Ex)
            {
