...
namespace PharmaSYSDistributorPlus.Reporting.Controls
{
    ...
    public partial class UclVATListPurchaseRegisterDate : ReportBaseControl
    {
        #region Declaration
        ...
        # region Constructor
        public UclVATListPurchaseRegisterDate()
        {
            try
            {
                InitializeComponent();
        ...
        public override void ShowOverview()
        {
            try
            {
                ...
                headerLabel1.Text = "VAT - PURCHASE REGISTER DATEWISE SUMMARY";
        ...
        private void PrintData()
        {
            ...
            try
            {
                ...
                foreach (DataGridViewRow dr in dgvReportList.Rows)
                {
                        ...
                        PrintRowCount += 1;
                        mamt = 0;
                        if (dr.Cells["Col_VoucherDate"].Value == null && dr.Cells["Col_Amount"].Value.ToString() != "")
                    {
        ...
        private int PrintHead()
        {
            ...
            try
            {
                ...
                PrintBill.Rows.Add(row);
                row = new PrintRow("Pur.6%VAT", PrintRowPixel, 170, PrintFont);
                PrintBill.Rows.Add(row);
                row = new PrintRow("VAT 6%", PrintRowPixel, 260, PrintFont);
                PrintBill.Rows.Add(row);
                row = new PrintRow("Pur.13.5%VAT", PrintRowPixel, 330, PrintFont);
                PrintBill.Rows.Add(row);
                row = new PrintRow("VAT 13.5%", PrintRowPixel, 420, PrintFont);
                PrintBill.Rows.Add(row);
        ...
        private void FillReportGrid()
        {
            try
            {
                ...
                {
                    dgvReportList.DataSource = _BindingSourceAll;
        ...
        private void FillReportData()
        {
            try
            {
                ...
                dtable = _Purchase.GetOverviewDataForVATReportDATE(_MFromDate, _MToDate);
                _BindingSource = dtable;
                dtable = _Purchase.GetOverviewDataForVATReportDATEALL();
                _BindingSourceAll = dtable;
            }
            catch (Exception ex)
            {
                Log.WriteException(ex);
        ...
        private void btnOKMultiSelectionClick()
        {
            ...
            {               
                ...
                if (retValue)
                {
                    ...
                    FillReportGrid();
                    PrintReportHead = "VAT Purchase Report [DATE] From: " + General.GetDateInShortDateFormat(_MFromDate) + " To: " + General.GetDateInShortDateFormat(_MToDate);
                    PrintReportHead2 = "";
