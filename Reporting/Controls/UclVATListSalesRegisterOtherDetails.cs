...
namespace PharmaSYSDistributorPlus.Reporting.Controls
{
    ...
    public partial class UclVATListSalesRegisterOtherDetails : ReportBaseControl
    {
        ...
        private double _WMTotalCashDiscount = 0;
        private double _WMTotalAddON = 0;
        private double _WMTotalCreditNote = 0;
        private double _WMTotalDebitNote = 0;
        #endregion
        ...
        private void CalculateFinalTotals()
        {
            ...
            _WMTotalCashDiscount = 0;
            _WMTotalAddON = 0;
            _WMTotalCreditNote = 0;
            _WMTotalDebitNote = 0;
            ...
            foreach (DataGridViewRow dr in dgvReportList.Rows)
            {
                ...
                {
                    _WMTotalCashDiscount += Convert.ToDouble(dr.Cells["Col_AmountDiscount"].Value.ToString());
                    _WMTotalAddON += Convert.ToDouble(dr.Cells["Col_AddOnFreight"].Value.ToString());
                    _WMTotalCreditNote += Convert.ToDouble(dr.Cells["Col_AmountCreditNote"].Value.ToString());
                    _WMTotalDebitNote += Convert.ToDouble(dr.Cells["Col_AmountDebitNote"].Value.ToString());
                }
            }
            int rowIndex = dgvReportList.Rows.Add();
            DataGridViewRow dgvrow = dgvReportList.Rows[rowIndex];
            ...
            if (General.ShopDetail.ShopDistributorSale == "Y")
            {
                ...
                dgvrow.Cells["Col_AmountDiscount"].Value = _WMTotalCashDiscount.ToString("#0.00");
                dgvrow.Cells["Col_AddOnFreight"].Value = _WMTotalAddON.ToString("#0.00");
                dgvrow.Cells["Col_AmountCreditNote"].Value = _WMTotalCreditNote.ToString("#0.00");
                dgvrow.Cells["Col_AmountDebitNote"].Value = _WMTotalDebitNote.ToString("#0.00");
                ...
                dgvrow.Cells["Col_AmountDiscount"].Value = (_MTotalCashDiscount - _WMTotalCashDiscount).ToString("#0.00");
                dgvrow.Cells["Col_AddOnFreight"].Value = ( _MTotalAddON - _WMTotalAddON).ToString("#0.00");
                dgvrow.Cells["Col_AmountCreditNote"].Value = (_MTotalCreditNote - _WMTotalCreditNote).ToString("#0.00");
                dgvrow.Cells["Col_AmountDebitNote"].Value = (_MTotalDebitNote - _WMTotalDebitNote).ToString("#0.00");
            }
