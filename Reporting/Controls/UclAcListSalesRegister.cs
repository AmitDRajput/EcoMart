...
//DataGridViewCellStyle style = new DataGridViewCellStyle();
       //     style.BackColor = Color.Pink;
        ...
        private void btnOKMultiSelectionClick()
        {
            ...
            try
            {
                ...
                if (retValue)
                {
                    ...
                    PrintReportHead = "Sale Register From: " + General.GetDateInShortDateFormat(_MFromDate) + " To: " + General.GetDateInShortDateFormat(_MToDate);
                    PrintReportHead2 = "";
                    FillReportGrid();
        ...
        private void CalculateFinalTotals()
        {
           ...
           // FreezeBand(dgvReportList.Rows[rowIndex]); 
        }
