...
{   
    ...
    public class LockTable
    {
        ...
        {
            string strSql = "LOCK TABLES tblStock Low_priority WRITE , tblvouchernumbers Low_priority WRITE, vouchersale Low_Priority WRITE , detailsale Low_Priority WRITE,  tbltrnac Low_Priority WRITE ,vouchercreditdebitnote LOW_PRIORITY WRITE, mastershelf READ, mastercompany READ , tbldailyshortlist LOW_PRIORITY WRITE,masterproduct Low_Priority WRITE, masterpatient Low_priority WRITE, masteraccount Low_priority WRITE, tblscanprescriptions Low_priority WRITE,masterdoctor Low_Priority WRITE";
            DBInterface.ExecuteQuery(strSql);                           
        }
        public static void LockTablesForSpecialSale()
        {
            string strSql = "LOCK TABLES specialvouchersale Low_Priority WRITE , specialdetailsale Low_Priority WRITE,vouchercreditdebitnote LOW_PRIORITY WRITE, mastershelf READ, mastercompany READ ,masterproduct Low_Priority WRITE, masterpatient Low_priority WRITE, masteraccount Low_priority WRITE";
            DBInterface.ExecuteQuery(strSql);
        }
        ...
        {
            string strSql = "LOCK TABLES tblvouchernumbers Low_priority WRITE, vouchercashbankreceipt Low_Priority WRITE , detailcashbankreceipt Low_Priority WRITE,vouchersale Low_priority WRITE,tbltrnac Low_priority WRITE,voucherstatement Low_priority WRITE,masteraccount Low_priority WRITE";
            DBInterface.ExecuteQuery(strSql);
        }
