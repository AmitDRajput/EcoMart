...
namespace PharmaSYSRetailPlus.BusinessLayer
{
    public class User:BaseObject
    {
        ...
        public bool AddDetails()
        {
            ...
            return dbAddUser.AddDetails(Id, Name,Password,IfInUse,Level,Description,CreatedBy,CreatedDate,CreatedTime);
                       
        }
        public bool UpdateDetails()
        {
            DBUser dbadduser = new DBUser();
            return dbadduser.UpdateDetails(Id, Name, Password, Level, IfInUse, Description, ModifiedBy, ModifiedDate, ModifiedTime);
        }
