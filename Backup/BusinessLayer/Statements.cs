    ...
    public class Statements : BaseObject
    {
        ...
        public bool AddAccountDetailsDebit()
        {
            ...
            try
            {
                ...
                bRetValue = dbs.AddAccountDetails(Id, DetailId, AccountID  ,StatementAmount ,0,FixAccounts.AccountCreditPurchase, VoucherType,0,CreatedDate ," ", CreatedBy, CreatedDate, CreatedTime);
            }
            catch (Exception Ex)
            {
                Log.WriteException(Ex);
        ...
        public bool AddAccountDetailsCredit()
        {
            ...
            {
                DetailId = Guid.NewGuid().ToString().ToUpper().Replace("-", "");
                bRetValue = dbs.AddAccountDetails(Id, DetailId, FixAccounts.AccountCreditPurchase , 0,StatementAmount , AccountID, VoucherType, 0, CreatedDate, " ", CreatedBy, CreatedDate, CreatedTime);
            }
            catch (Exception Ex)
            {
                Log.WriteException(Ex);
