...
namespace PharmaSYSRetailPlus.BusinessLayer
{
    public class Account : BaseObject
    {
        ...
        private string _AccVATTinNumber;
        ...
        public string AccVATTinNumber
        {
            get { return _AccVATTinNumber; }
            set { _AccVATTinNumber = value; }
        }
        ...
        public bool ReadDetailsByID()
        {
            ...
            try
            {
                ...
                if (drow != null)
                {
                    ...
                    if (drow["AccVATTinNumber"] != DBNull.Value)
                        AccVATTinNumber = Convert.ToString(drow["AccVATTinNumber"]);
        ...
        {
            DBAccount dbAccount = new DBAccount();
            return dbAccount.AddDetailsDr(Id, AccCode, AccName, AccGroupID, AccOpeningDebit,
                ...
                AccDbVisitDay1, AccDbVisitDay2, AccDbVisitDay3, AccNameAddress, AccVATTinNumber, AccDLN, AccTokenNumber,AccDiscountOffered, CreatedBy, CreatedDate, CreatedTime);
        }
        ...
        public bool UpdateDebtorDetails()
        {
            ...
            return dbAccount.UpdateDetailsDr(Id, AccCode, AccName, AccGroupID, AccOpeningDebit,
                AccOpeningCredit, AccAddress1, AccAddress2, AccEmailID, AccTransactionType, AccBankId, AccBranchID, AccDoctorID,
                AccTelephone, AccContactPerson, AccRemark1,AccRemark2, AccBirthDay, AccBirthMonth, AccBirthYear,
                AccDbVisitDay1, AccDbVisitDay2, AccDbVisitDay3, AccNameAddress, AccVATTinNumber, AccDLN, AccTokenNumber,AccDiscountOffered, ModifiedBy, ModifiedDate, ModifiedTime);
        }
        #endregion
        ...
        public bool AddCreditorDetails()
        {
            ...
            return dbAccount.AddDetailsCreditor(Id, AccCode, AccName, AccGroupID, AccOpeningDebit,
                AccOpeningCredit, AccAddress1, AccAddress2, AccEmailID, AccTelephone, AccContactPerson,
                AccRemark1,AccRemark2, AccCrVisitDays, AccShortName, AccDiscountOffered, AccVATTinNumber, AccDLN, AccStatement15Days,AccLessPercentInDebitNote, CreatedBy, CreatedDate, CreatedTime);
        }
        ...
        public bool UpdateCreditorDetails()
        {
            ...
            return dbAccount.UpdateDetailsCreditor(Id, AccCode, AccName, AccGroupID, AccOpeningDebit,
                AccOpeningCredit, AccAddress1,AccAddress2, AccEmailID, AccTelephone, AccContactPerson,
                AccRemark1,AccRemark2, AccCrVisitDays, AccShortName, AccDiscountOffered, AccVATTinNumber, AccDLN,AccStatement15Days,AccLessPercentInDebitNote, ModifiedBy, ModifiedDate, ModifiedTime);
        }
        ...
        public bool AddDetailsGnrl()
        {
            ...
            return dbAccount.AddDetailsGnrl(Id, AccCode, AccName, AccGroupID, AccOpeningDebit,
                AccOpeningCredit, AccAddress1, AccAddress2, AccEmailID, AccTelephone, AccContactPerson,
                AccRemark1,AccRemark2, AccVATTinNumber, AccPAN, CreatedDate, CreatedTime);
        }
        ...
        public bool UpdateDetailsGnrl()
        {
            ...
            return dbAccount.UpdateDetailsGnrl(Id, AccCode, AccName, AccGroupID, AccOpeningDebit,
                AccOpeningCredit, AccAddress1, AccAddress2, AccEmailID, AccTelephone, AccContactPerson,
                AccRemark1,AccRemark2, AccVATTinNumber, AccPAN, ModifiedDate, ModifiedTime);
        }
        #endregion
        ...
        {
            DBAccount dbData = new DBAccount();
            return dbData.GetStockInOutList(FixAccounts.AccountStockInOut);
        }
