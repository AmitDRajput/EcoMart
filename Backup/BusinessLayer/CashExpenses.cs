...
namespace PharmaSYSRetailPlus.BusinessLayer
{
    class CashExpenses : BaseObject
    {
        ...
        {
            DBCashExpenses CBtran = new DBCashExpenses();
            return CBtran.AddVoucherIntblTrnac(Id, CBAccountID, CBNarration, CBVouType, CBVouNo, CBVouDate, CBAmount,DetailId, CreatedBy, CreatedDate, CreatedTime);
        }
        public bool AddVoucherIntblTrnacReverse()
        {
            DBCashExpenses CBtran = new DBCashExpenses();
            return CBtran.AddVoucherIntblTrnacReverse(Id, CBAccountID, CBNarration, CBVouType, CBVouNo, CBVouDate, CBAmount, DetailId,CreatedBy, CreatedDate, CreatedTime);
        }
