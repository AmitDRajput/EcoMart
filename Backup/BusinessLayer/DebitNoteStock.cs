    ...
    class DebitNoteStock : BaseObject
    {
        ...
        public bool AddDetails()
        {
            ...
            return dbcrdb.AddDetails(Id, CrdbId, CrdbNarration, CrdbVouType, CrdbVouNo, CrdbVouDate, CrdbAmountNet,
               CrdbDiscPer, CrdbDiscAmt, CrdbTotalAmount, CrdbVat5, CrdbVat12point5, CrdbRoundAmount, CrdbAmountClear, CreatedBy, CreatedDate, CreatedTime);
        }
        public bool AddDetailsForSelected()
        {
            ...
            return dbcrdb.AddDetails(IDForSelected, CrdbId, CrdbNarration, CrdbVouType, CrdbVouNoForSelected, CrdbVouDate, CrdbBillAmountForSelected,
               CrdbDiscPer, crdbDiscAmtForSelected, CrdbBillAmountForSelected, CrdbVat5ForSelected, CrdbVat12point5ForSelected, CrdbRoundAmount, 0, CreatedBy, CreatedDate, CreatedTime);
        }
        ...
        public bool UpdateDetails()
        {
            ...
            return dbcrdb.UpdateDetails(Id, CrdbId, CrdbNarration, CrdbVouType, CrdbVouNo, CrdbVouDate, CrdbAmountNet,
                CrdbDiscPer, CrdbDiscAmt, CrdbTotalAmount, CrdbVat5, CrdbVat12point5, CrdbRoundAmount, CrdbAmountClear, ModifiedBy, ModifiedDate, ModifiedTime);
        }
