...
namespace PharmaSYSRetailPlus.Reporting.Controls
{
    ...
    public partial class ReportBaseControl : UserControl, IReportControl
    {
        ...
        public void ShowReportForm(string ID,string FromDate, string ToDate)
        {
            try
            {
                if (ReportControl != null)
                {
                    ...
                    ReportControl.ShowReport(ID, FromDate, ToDate);
        ...
        public virtual void EMail(string ExportFileName,string EmailID)
        {
        ...
        public void SendEmail()
        {
            string ExportFileName = "";
            string EmailID = "";
            if (txtFileName.Text != null && txtFileName.Text.ToString() != string.Empty && txtEmailID.Text != null && txtEmailID.Text.ToString() != string.Empty)
            {
