...
namespace PharmaSYSRetailPlus.Reporting.Controls
{
    ...
    public partial class UclSaleListDailySale : ReportBaseControl
    {
        ...
        private void PrintData()
        {
            ...
            try
            {
                PrintReportHead = "Daily Sale Date : " + General.GetDateInDateFormat(_MFromDate);
                PrintReportHead2 = "";
        ...
        private void dateVoucherTypeControlOneDateSale1_OnGoClicked(DateTime FromDate, VoucherType vType)
        {           
            OnGoClick(FromDate,vType);
        }

        private void OnGoClick(DateTime FromDate, VoucherType vType)
        {
            bool retValue = false;
            try
            {               
