...
namespace PharmaSYSRetailPlus.Reporting.Controls
{
    ...
    public partial class UclListBank : ReportBaseControl
    {
        #region Declaration
        ...
        private int PrintHead()
        {
            ...
            try
            {
                ...
                row = new PrintRow("Bank Name", PrintRowPixel, PrintColumnPixel, PrintFont);
                PrintBill.Rows.Add(row);
                PrintColumnPixel += 250;
        ...
        private void FillReportData()
        {
            ...
            {             
                _BindingSource = new DataTable();
                _BindingSource = _Bank.GetOverviewData();
            }
            catch (Exception ex)
            {
                Log.WriteException(ex);
