...
namespace PharmaSYSRetailPlus.Reporting.Controls
{
    ...
    public partial class UclVouChequePaidList : ReportBaseControl
    {
        # region Declaration
        ...
        private void FillReportData()
        {
            ...
            {
                _BindingSource = new DataTable();
                _BindingSource = _BankPayment.GetOverviewData(mcbBank.SelectedID, _VouType, _MFromDate, _MToDate);
            }
            catch (Exception ex)
            {
                Log.WriteException(ex);
