    ...
    public partial class UclVATListPurchaseRegisterDetail : ReportBaseControl
    {
        ...
        private int PrintHead()
        {
            ...
            try
            {
                ...
                PrintBill.Rows.Add(row);
                row = new PrintRow("Pur 5%", PrintRowPixel, 350, PrintFont);
                PrintBill.Rows.Add(row);
                row = new PrintRow("VAT 5%", PrintRowPixel, 420, PrintFont);
                PrintBill.Rows.Add(row);
                row = new PrintRow("Pur 12.5%", PrintRowPixel, 490, PrintFont);
                PrintBill.Rows.Add(row);
                row = new PrintRow("VAT 12.5%", PrintRowPixel, 550, PrintFont);
                PrintBill.Rows.Add(row);
