...
namespace PharmaSYSRetailPlus.Reporting.Controls
{
    ...
    public partial class UclListBranch : ReportBaseControl
    {
        #region Declaration
        ...
        #region Constructor
        public UclListBranch()
        {
            try
            {
                InitializeComponent();
                ViewControl = new UclBranch();
            }
            catch (Exception ex)
            {
        ...
        private int PrintHead()
        {
            ...
            try
            {
                ...
                row = new PrintRow("Branch Name", PrintRowPixel, PrintColumnPixel, PrintFont);
                PrintBill.Rows.Add(row);
                PrintColumnPixel += 250;
        ...
        private void ConstructReportColumns()
        {
            try
            {
                ...
                column.Name = "Col_ID";
                column.DataPropertyName = "BranchID";
        ...
        private void FillReportData()
        {
            ...
            { 
                _BindingSource = new DataTable();
                _BindingSource = _Branch.GetOverviewData();               
            }
            catch (Exception ex)
            {
                Log.WriteException(ex);
