...
namespace PharmaSYSRetailPlus.Reporting.Controls
{
    ...
    public partial class UclCreditDebitNotePartyList : ReportBaseControl
    { 
        # region Declaration
        ...
        private double _MTotalAmountCR;
     //   private double _MTotalAmountDB;
        # endregion

        #region Constructor
        public UclCreditDebitNotePartyList()
        {
            try
            {
                InitializeComponent();
        ...
        public override void ShowOverview()
        {
            try
            {
                ...
                headerLabel1.Text = "CREDIT/DEBIT NOTE LIST (PARTY)";
                ...
                foreach (DataRow dr in _BindingSource.Rows)
                {
                    if (dr["CRDBID"].ToString() != null)
                    {
                        ...
                        if (dr["AmountNet"] != DBNull.Value)
                            ...
                            _MTotalAmountCR += Convert.ToDouble(dr["AmountNet"].ToString());
        ...
        private void CalculateFinalTotals()
        {
            ...
            dgvrow.Cells["Col_Amount"].Value = _MTotalAmountCR.ToString("#0.00");
        }
        ...
        private void FillReportData()
        {
            try
            {
                ...
                dtable = _CreditDebitNote.GetDebitCreditNoteListByParty(mcbParty.SelectedID, _MFromDate, _MToDate);
