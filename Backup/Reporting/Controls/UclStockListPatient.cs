    ...
    public partial class UclStockListPatient : ReportBaseControl
    {
        ...
        private void PrintData()
        {
            ...
            try
            {
                ...
                string mdaystring = "";
                if (mday == 1)
                    mdaystring = mday.ToString() + "st";
                else if (mday == 2)
                    mdaystring = mday.ToString() + "nd";
                else if (mday == 3)
                    mdaystring = mday.ToString() + "rd";
                else
                    mdaystring = mday.ToString() + "th";
                PrintReportHead = "Stock [Patient Short List] Visiting on  " + mdaystring + "  Day of the Month";
                PrintReportHead2 = "";
