...
namespace PharmaSYSRetailPlus.Reporting.Controls
{
    ...
    public partial class UclListArea : ReportBaseControl
    {
        #region Declaration
        ...
        private int PrintHead()
        {
            ...
            try
            {
                ...
                row = new PrintRow("Area Name", PrintRowPixel, PrintColumnPixel, PrintFont);
                PrintBill.Rows.Add(row);
                PrintColumnPixel += 250;
        ...
        private void FillReportData()
        {
            ...
            {
                _BindingSource = new DataTable();
                _BindingSource = _Area.GetOverviewData();
