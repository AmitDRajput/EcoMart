    ...
    public partial class UclVATListPurchaseRegisterOtherDetails : ReportBaseControl
    {
        ...
        private int PrintHead()
        {
            ...
            try
            {
                ...
                PrintBill.Rows.Add(row);
                //row = new PrintRow("Pur 0%",PrintRowPixel, 340, PrintFont);
                //PrintBill.Rows.Add(row);
                //row = new PrintRow("Pur 5%", PrintRowPixel, 392, PrintFont);
                //PrintBill.Rows.Add(row);
                //row = new PrintRow("VAT 5%", PrintRowPixel, 450, PrintFont);
                //PrintBill.Rows.Add(row);
                //row = new PrintRow("Pur 12.5%", PrintRowPixel, 520, PrintFont);
                //PrintBill.Rows.Add(row);
                //row = new PrintRow("VAT 12.5%", PrintRowPixel, 580, PrintFont);
                //PrintBill.Rows.Add(row);
