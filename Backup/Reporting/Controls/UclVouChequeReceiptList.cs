...
namespace PharmaSYSRetailPlus.Reporting.Controls
{
    ...
    public partial class UclVouChequeReceiptList : ReportBaseControl
    {
        # region Declaration
        ...
        # region Contructor
        public UclVouChequeReceiptList()
        {
            try
            {
                InitializeComponent();
        ...
        public override void ShowOverview()
        {
            try
            {
                ...
                headerLabel1.Text = "VOUCHER LIST-CHEQUE RECEIPT LIST";              
                ClearControls();
                FillPartyCombo();
                FillBankCombo();
        ...
        private void PrintData()
        {
            ...
            try
            {
                ...
                PrintReportHead = "Bank Receipts From: " + General.GetDateInShortDateFormat(_MFromDate) + " To: " + General.GetDateInShortDateFormat(_MToDate);
                PrintReportHead2 = "";
        ...
        private void FillReportData()
        {
            ...
            {
                _BindingSource = new DataTable();
                _BindingSource = _BankReceipt.GetOverviewDataForReport(mcbBank.SelectedID, _VouType, _MFromDate, _MToDate);
        ...
        private void dgvReportList_DoubleClicked(object sender, EventArgs e)
        {
            ...
            try
            {
                if (dgvReportList.SelectedRow != null && dgvReportList.Rows.Count > 0)
                {
                    ...
                    string mvouchertype = dgvReportList.SelectedRow.Cells["Col_Type"].Value.ToString();
