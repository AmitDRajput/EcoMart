...
namespace PharmaSYSRetailPlus.Reporting.Controls
{
    ...
    public partial class UclCreditNoteStockInListProduct : ReportBaseControl
    {
        # region Declaration
        private DataTable _BindingSource;      
        private CreditDebitNote _CreditDebitNote;
        public string mvoutype = FixAccounts.VoucherTypeForStockIN;
        private string _MFromDate;
        private string _MToDate;
        # endregion
        
        public UclCreditNoteStockInListProduct()
        {
            try
            {
                InitializeComponent();
        ...
        public override void ShowOverview()
        {
            try
            {
                ...
                headerLabel1.Text = "STOCK IN LIST (PRODUCT)";
