...
namespace PharmaSYSRetailPlus.Reporting.Controls
{
    ...
    public partial class UclCreditNoteList : ReportBaseControl
    {
        # region Declaration
        private DataTable _BindingSource;
        private CreditNoteStock _CreditNoteStock;
        ...
        public override void ShowOverview()
        {
            try
            {
                ...
                _CreditNoteStock = new CreditNoteStock();
                _MFromDate = General.ShopDetail.Shopsy;
                _MToDate = General.ShopDetail.Shopey;
                headerLabel1.Text = "CREDIT NOTE LIST";
        ...
        private void PrintData()
        {
            ...
            try
            {
                PrintReportHead = "CREDIT NOTE  LIST From: " + General.GetDateInShortDateFormat(_MFromDate) + " To: " + General.GetDateInShortDateFormat(_MToDate);
                PrintReportHead2 = "";
            ...
            try
            {
                ...
                foreach (DataRow dr in _BindingSource.Rows)
                {
                    if (dr["CRDBID"].ToString() != null)
                    {
                        ...
                        ifAllow = CheckFilter(drID, drType, drAmt);
                        if (ifAllow)
                        {
        ...
        private bool CheckFilter(string drID, string drtype, double dramt)
        {
            bool retValue = false;
            try
            {
        ...
        private void FillReportData()
        {
            try
            {
                ...
                dtable = _CreditNoteStock.GetOverviewDataCreditNotes(_MFromDate, _MToDate);
        ...
        private void dgvReportList_DoubleClicked(object sender, EventArgs e)
        {
            ...
            try
            {
                if (dgvReportList.SelectedRow != null && dgvReportList.Rows.Count > 0)
                {
                    ...
                    string mvouchertype = dgvReportList.SelectedRow.Cells["Col_VoucherType"].Value.ToString();
                    if (mvouchertype == FixAccounts.VoucherTypeForCreditNoteStock)
