...
using PharmaSYSRetailPlus.InterfaceLayer.Validation;
...
namespace PharmaSYSRetailPlus.InterfaceLayer
{
    ...
    { 
        ...
        {
            InitializeComponent();
         //   this.Icon = PharmaSYSRetailPlus.Properties.Resources.Icon;
        ...
        public void Initialize(WizardStates state)
        {
            try
            {
                ...
                else if (currentState == WizardStates.State_TrialLicense)
                {
                    ...
                    DateTime lastRunDate = LicenseLib.Licence.GetDateTime(General.PharmaSysRetailPlusLicense.LastRunDate);
        ...
        private void SaveLicense()
        {
            try
            {
                PharmaSysRetailPlusLic licData = new PharmaSysRetailPlusLic();
                licData.Read();
                licData.Data = General.PharmaSysRetailPlusLicense.GetLicenseData(General.PharmaSysRetailPlusLicense);
        ...
        private bool IsLicenseAssociateToThisPC()
        {
            ...
            try
            {
                string localMACID = PharmaSYSRetailPlus.InterfaceLayer.Classes.NetworkBrowser.GetLocalMacAddress();
        ...
        {
            General.PharmaSysRetailPlusLicense.LastRunDate = Licence.GetDateTimeString(DateTime.Now);
            SaveLicense();
        ...
        private void btnFinish_Click(object sender, EventArgs e)
        {
            if (currentState == WizardStates.State_Association)
            {
                ...
                for (int index = 0; index < General.PharmaSysRetailPlusLicense.UserCount; index++)
                {
                    General.PharmaSysRetailPlusLicense.AssociationList.SetItem(index, associationList[index].ToString());
                }
                SaveLicense();
        ...
        {
            if (General.PharmaSysRetailPlusLicense.LicenseType == LicenseTypes.Trial)
            {
                btnNext.Visible = false;
                btnFinish.Visible = true;
            }
