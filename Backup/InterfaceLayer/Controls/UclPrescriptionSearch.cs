...
namespace PharmaSYSRetailPlus.InterfaceLayer
{
    ...
    public partial class UclPrescriptionSearch : SearchControl
    {
        # region declaration
        ...
        public override void ShowOverview()
        {
            try
            {
                ...
                headerLabelForOverView1.Text = "PRESCRIPTION -> SEARCH";
        ...
        private void ConstructSearchColumns()
        {
            ...
            try
            {
                ...
                column.Name = "Col_ID";
                column.DataPropertyName = "PrescriptionId";
                column.HeaderText = "ID";
                column.Visible = false;
                dgvSearchList.Columns.Add(column);

                column = new DataGridViewTextBoxColumn();
                column.Name = "Col_PrescriptionName";
                column.DataPropertyName = "PrescriptionName";
                column.HeaderText = "Prescription Name";
                column.Width = 580;
                dgvSearchList.Columns.Add(column);
            }
            catch (Exception ex)
        ...
        private void FillSearchGridData()
        {
            try
            {
                ...
                dtable = _Prescription.GetOverviewData();
