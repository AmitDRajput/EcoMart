...
namespace PharmaSYSRetailPlus.InterfaceLayer
{
    ...
    public partial class UclPurchaseWithoutStockSearch : SearchControl
    {
        #region Declaration
        ...
        # region Constructor
        public UclPurchaseWithoutStockSearch()
        {
            try
            {
                InitializeComponent();
        ...
        private void FillSearchGridData()
        {
            try
            {
                ...
                dtable = _Purchase.GetOverviewDataForWithoutStockSearch();
