...
namespace PharmaSYSRetailPlus.InterfaceLayer
{
    ...
    public partial class UclContraEntrySearch : SearchControl
    {
        # region declaration
        ...
        public override void ShowOverview()
        {
            try
            {
                ...
                headerLabelForOverView1.Text = "CONTRA ENTRY -> SEARCH";
        ...
        private void FillSearchGridData()
        {
            try
            {
                ...
                dtable = _ContraEntry.GetOverviewData(_ContraEntry.CBVouType);
