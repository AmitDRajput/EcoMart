...
namespace PharmaSYSRetailPlus.InterfaceLayer
{
    ...
    public partial class UclStockInSearch : SearchControl
    {
        # region declaration
        ...
        public override void ShowOverview()
        {
            try
            {
                ...
                headerLabelForOverView1.Text = "STOCK IN -> SEARCH";
        ...
        private void FillSearchGridData()
        {
            try
            {
                ...
                dtable = _StockIn.GetOverviewData(_StockIn.CrdbVouType);
