    ...
    public partial class UclInstitutionalSale : BaseControl
    {
        ...
        private void FillPartyCombo()
        {
            try
            {
                ...
                mcbCreditor.SourceDataString = new string[9] { "AccountID", "AccCode", "AccName", "AccAddress1", "AccAddress2", "AccNameAddress", "AccTokenNumber", "AccDoctorID", "AccTransactionType" };
                mcbCreditor.ColumnWidth = new string[9] { "0", "20", "200", "200", "0", "200", "0", "0", "0" };
        ...
        //        txtAmountforZeroVAT.Text = mtotamtvat0.ToString("#0.00");
        //        txtTotalAmountForDiscount.Text = Math.Round(TotalAmountforDiscount, 2).ToString("#0.00");
        //        txtAmountVAT5Per.Text = mtotamtvat5.ToString("#0.00");
        //        txtAmountVAT12Point5Per.Text = mtotamtvat12.ToString("#0.00");
        //        txtPMTDiscountAmount.Text = mtotpmtdiscamt.ToString("#0.00");
        ...
        //    double.TryParse(txtITEMDiscountAmount.Text.ToString(), out mpmtamt);
        //    try
        //    {
        //        mdblDiscAmount = Math.Round(((mdblAmount) * mdblDiscPer / 100), 2);
        //        txtDiscAmount.Text = mdblDiscAmount.ToString("#0.00");
        //        mtotamt = Math.Round(mdblAmount - mdblDiscAmount - mpmtamt + maddon + mdebitnote, 2);
        //        if (mcreditnote < mtotamt)
        //            mtotamt = Math.Round(mtotamt - mcreditnote, 2);
        //        else
        //        {
