...
namespace PharmaSYSRetailPlus.InterfaceLayer
{
    ...
    public partial class UclSaleWithOutStockSearch : SearchControl
    {
        #region Declaration
        ...
        #region Constructor
        public UclSaleWithOutStockSearch()
        {
             try
            {
            InitializeComponent();
        ...
        public override void ShowOverview()
        {
            try
            {
                ...
                _SSSale = new SSSale();
                headerLabelForOverView1.Text = "CASH SALE SEARCH";
        ...
        private void FillSearchGridData()
        {
            try
            {
                ...
                dtable = _SSSale.GetOverviewData(FixAccounts.SubTypeForSaleWithoutStock);
