...
namespace PharmaSYSRetailPlus.InterfaceLayer.CommonControls
{
    ...
    public partial class UclCashReceiptSearch : SearchControl
    {
        #region Declaration
        ...
        public override void ShowOverview()
        {
            try
            {
                ...
                headerLabelForOverView1.Text = "CASH RECEIPT -> SEARCH";
        ...
        private void FillSearchGridData()
        {
            try
            {
                ...
                dtable = _CashReceipt.GetOverviewData(_CashReceipt.CBVouType);
