...
namespace PharmaSYSRetailPlus.InterfaceLayer
{
    ...
    public partial class UclDebtorSale : BaseControl
    {
        ...
        //        PrintBill.Rows.Add(row);
        //        row = new PrintRow(_SSSale.CrdbAmountNet.ToString("#0.00"), PrintRowPixel, 700, fnt);
        //        PrintBill.Rows.Add(row);
        //        PrintRowPixel = 418;
        ...
        //        row = new PrintRow(_SSSale.CrdbVouNo.ToString(), PrintRowPixel, 400, fnt);
        //        PrintBill.Rows.Add(row);

        //        PrintRowPixel = PrintRowPixel + 36;

        //        //   row = new PrintRow(_SSSale.ShortName, 73, 40, fnt);

        //        row = new PrintRow(_SSSale.ShortName, PrintRowPixel, 40, fnt);
        //        PrintBill.Rows.Add(row);

        //        //  row = new PrintRow(_SSSale.DoctorNameAddress, 107, 30, fnt);

        //        PrintRowPixel = PrintRowPixel + 34;

        //        row = new PrintRow(_SSSale.DoctorNameAddress, PrintRowPixel, 30, fnt);
        //        PrintBill.Rows.Add(row);

        //        row = new PrintRow(DateTime.Now.TimeOfDay.ToString().Substring(0, 5), PrintRowPixel, 520, fnt);
        //        PrintBill.Rows.Add(row);

        //        row = new PrintRow(_SSSale.CrdbVouDate, PrintRowPixel, 680, fnt);
        //        PrintBill.Rows.Add(row);
        //        PrintPageNumber += 1;
