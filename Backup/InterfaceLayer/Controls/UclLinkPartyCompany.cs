...
namespace PharmaSYSRetailPlus.InterfaceLayer
{
    ...
    public partial class UclPartyCompany : BaseControl 
    {
        ...
        public override bool Delete()
        {
            ...
            //    headerLabel1.Text = "PARTY COMPANY -> DELETE";
            //    btnViewAll.Visible = false;
        ...
        public override bool ProcessDelete()
        {
            ...
            //try
            //{
            //    if (_PartyCompany.Id != null && _PartyCompany.Id != "")
            //    {
            //        retValue = _PartyCompany.CanBeDeleted();
            //        if (retValue == true)
            //        {
            //            retValue = _PartyCompany.DeleteDetails();
            //            MessageBox.Show("PartyCompany information has been Deleted successfully.", "PharmaSYS+Gold", MessageBoxButtons.OK, MessageBoxIcon.Information);
            //        }
            //        else
            //        {
            //            MessageBox.Show("Cannot Delete.", "PharmaSYS+Gold", MessageBoxButtons.OK, MessageBoxIcon.Information);
            //        }
            //    }
            //    ClearData();
            //    FillPartyCombo();
        ...
        private void FillCompanyCombo()
        {
            try
            {
                ...
                mcbCompany.ColumnWidth = new string[2] { "0", "200" };
        ...
        {            
            ...
            try
            {
                ...
                for (int index = 0; index < dtable.Rows.Count; index++)
                {
                    ...
                    dr.Cells[2].Value = dtable.Rows[index]["CreatedUserID"].ToString();
                    dr.Cells[3].Value = dtable.Rows[index]["CreatedDate"].ToString();
                    dr.Cells[4].Value = dtable.Rows[index]["CreatedTime"].ToString();
                }
