...
namespace PharmaSYSRetailPlus.InterfaceLayer
{
    ...
    public partial class UclCustomerSearch : SearchControl
    {
        #region Declaration
        ...
        public override void ShowOverview()
        {
            try
            {
                ...
                headerLabelForOverView1.Text = "CUSTOMER -> SEARCH";
        ...
        private void ConstructSearchColumns()
        {
            ...
            try
            {
                ...
                column.DataPropertyName = "CustomerNameAddress";
                column.HeaderText = "Customer Name Address";
                column.Width = 580;
                dgvSearchList.Columns.Add(column);
            }
            catch (Exception ex)
        ...
        private void FillSearchGridData()
        {
            try
            {
                ...
                dtable = _Customer.GetOverviewData();
