...
namespace PharmaSYSRetailPlus.InterfaceLayer
{
    ...
    public partial class UclStatementPartywisePurchaseSearch : SearchControl
    {
        #region Declaration
        ...
        #region Contructor
        public UclStatementPartywisePurchaseSearch()
        {
            try
            {
                InitializeComponent();               
        ...
        private void FillSearchGridData()
        {
            try
            {
                ...
                dtable = _Statements.GetOverviewDataByType(FixAccounts.VoucherTypeForStatementPurchase);
