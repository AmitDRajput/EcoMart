...
namespace PharmaSYSRetailPlus.InterfaceLayer
{
    ...
    public partial class UclDebitNoteAmountSearch : SearchControl
    {
        # region Declaration
        private DataTable _BindingSource;
        private DebitNoteAmount _DebitNoteAmount;      
        #endregion

        # region Constructor
        public UclDebitNoteAmountSearch()
        {
            try
            {
                InitializeComponent();
        ...
        public override void ShowOverview()
        {
            try
            {
                ...
                _DebitNoteAmount = new DebitNoteAmount();
                headerLabelForOverView1.Text = "DEBIT NOTE AMOUNT OVERVIEW";
        ...
        private void FillSearchGridData()
        {
            try
            {
                ...
                dtable = _DebitNoteAmount.GetOverviewData();
