            ...
            try
            {
                ...
                if (mmrp > 0 || mgridamttot > 0)
                {
                    ...
                    if (General.CurrentSetting.MsetPurchaseAddVATInPurchaseRate == "Y")
                        mprate = mtraderateafterscm + mpurvatamt + mcstamt - _Purchase.AmountScmDiscountPerUnit - mitemdiscamt - _Purchase.AmountCashDiscountPerUnit;
                    else
