...
namespace PharmaSYSRetailPlus.InterfaceLayer
{
    ...
    public partial class UclCreditNoteAmountSearch : SearchControl
        
    {
        # region Declaration
        private DataTable _BindingSource;
        private CreditNoteAmount _CreditNoteAmount;     
        #endregion

        # region Constructor
        public UclCreditNoteAmountSearch()
        {
            try
            {
                InitializeComponent();
        ...
        public override void ShowOverview()
        {
            try
            {
                ...
                _CreditNoteAmount = new CreditNoteAmount();
                headerLabelForOverView1.Text = "CREDIT NOTE AMOUNT -> SEARCH";
        ...
        private void FillSearchGridData()
        {
            try
            {
                ...
                dtable = _CreditNoteAmount.GetOverviewData();
