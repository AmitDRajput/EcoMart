...
namespace PharmaSYSRetailPlus.InterfaceLayer
{
    ...
    public partial class UclCashExpensesSearch : SearchControl
    {
        # region declaration
        ...
        public override void ShowOverview()
        {
            try
            {
                ...
                headerLabelForOverView1.Text = "CASH EXPENSES -> SEARCH";
        ...
        private void FillSearchGridData()
        {
            try
            {
                ...
                dtable = _CashExpenses.GetOverviewData(_CashExpenses.CBVouType);
