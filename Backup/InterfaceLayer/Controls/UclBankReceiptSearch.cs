...
namespace PharmaSYSRetailPlus.InterfaceLayer
{
    ...
    public partial class UclBankReceiptSearch : SearchControl
    {
        # region declaration
        ...
        public override void ShowOverview()
        {
            try
            {
                ...
                headerLabelForOverView1.Text = "BANK RECEIPT -> SEARCH";
        ...
        private void FillSearchGridData()
        {
            try
            {
                ...
                dtable = _BankReceipt.GetOverviewData(_BankReceipt.CBVouType);
