...
namespace PharmaSYSRetailPlus.InterfaceLayer.CommonControls
{
    public partial class PSProductViewControl : UserControl
    {
        ...
        private bool _ShowpnlProductContent = true;
        ...
        // ss 15/12/2014
        public bool ShowpnlProductContent
        {
            get { return _ShowpnlProductContent; }
            set
            {
                _ShowpnlProductContent = value;
                if (_ShowpnlProductContent)
                {
                    pnlProductContent.Visible = true;

                }
                else
                {
                    pnlProductContent.Visible = false;
                }
            }
        }
        ...
        //            {
        //            //  ss // soldQuantity = Convert.ToInt32(htDeletedStock[tStock.StockId]);
        //                soldQuantity = Convert.ToInt32(dataGridViewRow.Cells["Col_Quantity"].Value.ToString());
        //            }
        //            if (dataGridViewRow.Cells["Col_Quantity"].Value != null)
        //            {
        //                // ss 26/12/2013
        ...
        private void dgProductListGrid_VisibleChanged(object sender, EventArgs e)
        {
            try
            {
                if (dgProductListGrid.Visible)
                {
                    if (ShowpnlProductContent)
                    {
                        pnlProductContent.Visible = true;
                        pnlProductContent.Width = dgProductListGrid.Width;
                        pnlProductContent.Location = new Point(dgProductListGrid.Location.X, dgProductListGrid.Location.Y + dgProductListGrid.Height);
                    }
                    else
                        pnlProductContent.Visible = false;
                }
        ...
        private void FillProductContents()
        {
            try
            {
                ...
                if (_DataGridViewSelectedRow != null)
                {
                    ...
                    {
                        lblGenericCategoryName.Text = _DataGridViewSelectedRow.Cells["Col_GenericCategoryName"].Value.ToString();
                    }
                }
