namespace PharmaSYSRetailPlus.InterfaceLayer.CommonControls
{
    partial class PSProductViewControlForBillReprint
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.dgMainGrid = new PharmaSYSRetailPlus.InterfaceLayer.CommonControls.PSProductMainGridViewForBillReprint();
            ...
            this.dgMainGrid.OnCellValueChangeCommited += new PharmaSYSRetailPlus.InterfaceLayer.CommonControls.PSProductMainGridViewForBillReprint.CellValueChangeCommited(this.dgMainGrid_OnCellValueChangeCommited);
            this.dgMainGrid.OnEnterKeyPressed += new PharmaSYSRetailPlus.InterfaceLayer.CommonControls.PSProductMainGridViewForBillReprint.EnterKeyPressed(this.dgMainGrid_EnterKeyPressed);
            this.dgMainGrid.OnArrowUpDownPressed += new PharmaSYSRetailPlus.InterfaceLayer.CommonControls.PSProductMainGridViewForBillReprint.ArrowUpDownPressed(this.dgMainGrid_OnArrowUpDownPressed);
            ...
            this.dgMainGrid.OnCellTextChanged += new PharmaSYSRetailPlus.InterfaceLayer.CommonControls.PSProductMainGridViewForBillReprint.CellTextChanged(this.dgMainGrid_OnCellTextChanged);
