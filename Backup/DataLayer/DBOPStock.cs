...
namespace PharmaSYSRetailPlus.DataLayer
{
    public class DBOPStock
    {
        ...
        public bool AddProductDetailsInStockTable(string ProductID, string Batchno, double TradeRate, double PurchaseRate, double MRP, double SaleRate,
            ...
            string accountId, string billnumber, string voutype, int vounumber, string voudate,string stockid, int BeginningStock, string createdby, string createddate, string createdtime)
        {
            bool bRetValue = false;
            string strSql = GetInsertQueryDetailsInStockTable(ProductID, Batchno, TradeRate, PurchaseRate, MRP, SaleRate,
                    ...
                    accountId, billnumber, voutype, vounumber, voudate,stockid,BeginningStock, createdby, createddate,createdtime);
            if (DBInterface.ExecuteQuery(strSql) > 0)
            {
                bRetValue = true;
            }
