...
namespace PharmaSYSRetailPlus.DataLayer
{
    public class DBDebtorProduct
    {
        ...
        public bool AddProductDetails(string accId, string detailID, string ProductID, int Quantity, string createdby, string createddate, string createdtime, string modifiedby, string modifieddate, string modifiedtime)
        {
        ...
        private string GetInsertProductQuery(string accId, string detailID, string ProductID, int Quantity, string createdby, string createddate, string createdtime, string modifyby, string modifydate, string modifytime)
        {
