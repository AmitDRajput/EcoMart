    ...
    public class DBPatient
    {
        ...
        public DataTable GetOverviewData()
        {
            ...
            string strsql = "Select a.PatientID,a.PatientName,a.PatientAddress1,a.PatientAddress2," +
                            "a.TelephoneNumber,a.Email,a.BirthDay,a.BirthMonth,a.BirthYear," +
                            "a.VisitDay1,a.VisitDay2,a.VisitDay3,a.ShortNameAddress,a.DoctorID,a.Remark1,a.Remark2,a.Remark3,a.TokenNumber,a.Acccode,a.DiscountOffered,b.DocID,b.DocName from masterpatient a  left outer join masterdoctor b on a.DoctorID = b.DocID where PatientName != '' order by PatientName" ;
        ...
        public DataTable GetOverviewDataForCounterSale()
        {
            ...
            string strsql = "Select PatientID,AccCode,PatientName,PatientAddress1,PatientAddress2," +
                            "ShortNameAddress,DoctorID,1 as AccTransactionType from masterpatient " +
        ...
        public DataRow ReadDetailsByID(string Id)
        {
            ...
            if (Id != "")
            {
                string strsql = "Select PatientID,PatientName,PatientAddress1,PatientAddress2," +
                            ...
                            "VisitDay1,VisitDay2,VisitDay3,ShortNameAddress,DoctorID,Remark1,Remark2,Remark3 from masterpatient  where PatientID= '{0}'";
        ...
        public bool AddDetails(string Id, string PatientName,
            ...
            string ShortNameAddres, string DoctorID, string Remark1,string Remark2, string Remark3, int tokannumber,string Gender, string createdby, string createddate, string createdtime)
        {
            bool bRetValue = false;
            string strSql = GetInsertQuery(Id, PatientName,
               Address1, Address2, Telephone, Email, BDay, BMonth, BYear,
               Visit1, Visit2, Visit3, ShortNameAddres, DoctorID, Remark1, Remark2,Remark3,tokannumber,Gender, createdby,createddate,createdtime);
        ...
        public bool UpdateDetails(string Id, string PatientName,
             string Address1, string Address2, string Telephone,
            string Email, int BDay, int BMonth, int BYear, int Visit1, int Visit2, int Visit3,
            string ShortNameAddres, string DoctorID, string Remark1,string Remark2,string Remark3, int tokannumber,string Gender, string modifiedby, string modifieddate, string modifiedtime)
        {
            bool bRetValue = false;
            string strSql = GetUpdateQuery(Id, PatientName,
               Address1,Address2, Telephone, Email, BDay, BMonth, BYear,
               Visit1, Visit2, Visit3, ShortNameAddres, DoctorID, Remark1,Remark2,Remark3, tokannumber,Gender, modifiedby,modifieddate,modifiedtime);
            if (DBInterface.ExecuteQuery(strSql) > 0)
            {
                bRetValue = true;
            }
        ...
        private string GetInsertQuery(string Id, string PatientName,
            ...
            string ShortNameAddres, string DoctorID, string Remark1, string Remark2, string Remark3, int tokennumber,string Gender, string createdby, string createddate, string createdtime)
        {
        ...
        private string GetUpdateQuery(string Id, string PatientName,
             string PatientAddress1,string PatientAddress2, string TelephoneNumber,
            string Email, int BirthDay, int BirthMonth, int BirthYear, int VisitDay1, int VisitDay2, int VisitDay3,
            string ShortNameAddres, string DoctorID, string Remark1, string Remark2, string Remark3, int tokennumber,string Gender, string modifiedby, string modifieddate, string modifiedtime)
        {
            Query objQuery = new Query();
            objQuery.Table = "masterpatient";
