...
namespace PharmaSYSRetailPlus.DataLayer
{
    public class DBAccountDetails
    {
        ...
        public bool AddDetailsForAccountsPurchase(string VoucherId, string DetailID, string accountid, double debit, double credit, string accaccountid, string VoucherType, int VoucherNumber, string transactiondate, string Narration, string createdby, string createddate, string createdtime)
        {
            bool bRetValue = false;
            string strSql = GetInsertQueryForAccountsPurchase(VoucherId, DetailID, accountid, debit, credit, accaccountid, VoucherType, VoucherNumber, transactiondate, Narration, createdby, createddate, createdtime);
        ...
        private string GetInsertQueryForAccountsPurchase(string purchaseID, string DetailID, string accountID, double debit, double credit, string accaccountid, string VoucherType, int VoucherNumber, string transactiondate, string Narration, string createdby, string createddate, string createdtime)
        {
        ...
        private string GetInsertQueryForAccountsBankPayment(string purchaseID, string DetailID, string accountID, double debit, double credit, string accaccountid, string VoucherType, int VoucherNumber, string transactiondate, string Narration, string chqno, string chqdate, string createdby, string createddate, string createdtime)
        {
            Query objQuery = new Query();
            objQuery.Table = "tbltrnac";
            objQuery.AddToQuery("tblTrnacID", DetailID);
        ...
        public bool AddDetailsForAccountsCashPayment(string VoucherId, string DetailID, string accountid, double debit, double credit, string accaccountid, string VoucherType, int VoucherNumber, string transactiondate, string Narration, string createdby, string createddate, string createdtime)
        {
            bool bRetValue = false;
        ...
        private string GetInsertQueryForAccountsCashPayment(string purchaseID, string DetailID, string accountID, double debit, double credit, string accaccountid, string VoucherType, int VoucherNumber, string transactiondate, string Narration, string createdby, string createddate, string createdtime)
        {
            Query objQuery = new Query();
            objQuery.Table = "tbltrnac";
            objQuery.AddToQuery("tblTrnacID", DetailID);
        ...
        public bool AddDetailsForAccountsCashReceipt(string VoucherId, string DetailID, string accountid, double debit, double credit, string accaccountid, string VoucherType, int VoucherNumber, string transactiondate, string Narration, string createdby, string createddate, string createdtime)
        {
            bool bRetValue = false;
        ...
        private string GetInsertQueryForAccountsCashReceipt(string voucherID, string DetailID, string accountID, double debit, double credit, string accaccountid, string VoucherType, int VoucherNumber, string transactiondate, string Narration, string createdby, string createddate, string createdtime)
        {
            Query objQuery = new Query();
            objQuery.Table = "tbltrnac";
            objQuery.AddToQuery("tblTrnacID", DetailID);
        ...
        public DataTable GetGeneralLedgerByClearedDate(string fromDate, string toDate, string accountID)
        {
            ...
            string strSql = "Select a.VoucherID, a.AccountID,a.Debit,a.Credit,a.AccAccountID,a.TransactionDate, ClearedDate," +
                 "a.VoucherType,a.VoucherSubType,a.VoucherNumber,a.VoucherDate,a.Narration,a.ChequeNumber,a.ChequeDate,a.BankID,a.BranchID,a.CreatedDate,a.CreatedTime, b.AccountID,b.AccName,b.AccCode,c.BankName,d.BranchName from tbltrnac a inner join masteraccount b on a.AccAccountID = b.AccountID left outer join masterbank c on a.BankID = c.BankID left outer join masterbranch d on a.BranchID = d.BranchID  where  a.AccountID = '" + accountID + "' &&  a.ClearedDate <= '" + toDate + "'order by a.TransactionDate,a.CreatedTime";
        ...
        {
            DataTable dt = new DataTable();
            string strSql = "Select  a.AccountID,a.AccName,a.AccCode,a.Accopeningdebit ,a.accopeningcredit , b.AccountID,sum(b.Debit) as debit ,sum(b.Credit) as credit ,b.TransactionDate " +
                 "   from masteraccount a left outer join  tbltrnac b  on a.AccountID = b.AccountID   where a.AccCode = 'D'  Group by a.AccountID  having b.TransactionDate <= '" + mdate + "' || b.transactiondate = ''  order by a.AccName";
        ...
        public DataTable GetGroupsUnderLevel3(int GrpID3)
        {
            ...
            string strSql = "select groupID,GroupName,UnderGroupID,OpeningDebit,OpeningCredit,TransactionDebit,TransactionCredit,ClosingDebit,ClosingCredit from masterGroup where UnderGroupID = '" + GrpID3 + "'" +
                " union select AccgroupID as groupID ,AccName as GroupName ,'' as UnderGroupID,AccOpeningDebit as OpeningDebit,AccOpeningCredit as OpeningCredit,AccTransactionDebit as TransactionDebit,AccTransactionCredit as TransactionCredit,AccClosingDebit as ClosingDebit,AccClosingCredit as ClosingCredit from masterAccount where AccGroupID = '" + GrpID3 + "'";
            dt = DBInterface.SelectDataTable(strSql);
            return dt;
        }
        ...
        {
            DataTable dt = new DataTable();
            string strSql = "select voucherID, voucherType,VoucherNumber,TransactionDate, sum(Debit) as debit,sum(Credit) as credit from tbltrnac group by voucherID";
            dt = DBInterface.SelectDataTable(strSql);
            return dt; 
        }
    }
