...
namespace PharmaSYSRetailPlus.DataLayer
{
    class DBStock
    {
        ...
        {
            DataTable dtable = new DataTable();
            string strSql = string.Format("Select a.ProductId,a.BatchNumber,a.MRP,a.PurchaseRate from tblstock a where ProductID = '{0}' group by a.ProductID,a.BatchNumber", prodID );
            dtable = DBInterface.SelectDataTable(strSql);
            return dtable;
        }
