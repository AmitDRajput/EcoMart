...
namespace PharmaSYSRetailPlus.DataLayer
{
    class DBDebitNoteAmount
    {
        ...
        public DataTable ReadParticularById(string Id)
        {
            ...
            if (Id != "")
            {
                string strsql = "Select CRDBID,Particulars, Amount from detailcreditdebitnoteamount where CRDBID = '{0}' order by SerialNumber";
        ...
        public DataRow ReadDetailsByVouNumber(int vouno)
        {
            ...
            if (vouno != 0)
            {
                string strSql = "Select * from vouchercreditdebitnote where VoucherNumber='{0}' &&  (VoucherType = '"+ FixAccounts.VoucherTypeForDebitNoteStock +"' || VoucherType = '"+ FixAccounts.VoucherTypeForDebitNoteAmount +"') ";
        ...
        public bool AddParticularsDetails(string Id, string Particulars, double Amount, string MyDbAmtID,int serialNumber)
        {
        ...
        private string GetInsertParticularsQuery(string Id, string Particulars, double Amount, string MyDBAmtID, int serialNumber)
        {
